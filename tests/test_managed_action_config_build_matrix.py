...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            "any",
            False,
            id="occupied_plus_dark_keeps_ambient_vacant_guard",
        ),
        pytest.param(
            ("on_vacant", "on_bright"),
            "any",
            ...
            "any",
            True,
            id="vacant_plus_bright_keeps_ambient_occupied_guard",
        ),
        pytest.param(
            ("on_occupied", "on_bright"),
            "dark",
            None,
            "dark",
            None,
            id="occupied_plus_bright_keeps_occupancy_dark_guard",
        ),
        pytest.param(
            ("on_vacant", "on_dark"),
            "bright",
            ...
            "bright",
            None,
            id="vacant_plus_dark_keeps_occupancy_bright_guard",
        ),
