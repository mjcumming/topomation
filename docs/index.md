...
| `docs/examples.md` | User-facing household examples and starter scenarios | Active |
| `docs/occupancy-lock-workflows.md` | Automation-first lock policy workflows (`away`, `party`) | Active |
| `docs/wasp-in-box-whitepaper.md` | Occupancy design white paper (wasp-in-box inference, related occupancy patterns, UX guidance) | Active (Reference) |
