...
canonical topology rows remove those rows and reparent children; managed-shadow
...
class SyncManager:
    ...
    def reconcile_missing_ha_area_wrappers(self, *, run_shadow_reconcile: bool = True) -> None:
        ...
        Managed-shadow rows and user area wrappers are both dropped here; managed
