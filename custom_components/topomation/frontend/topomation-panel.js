 ...
 */
const fe = globalThis, $i = fe.ShadowRoot && (fe.ShadyCSS === void 0 || fe.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Ai = Symbol(), Mi = /* @__PURE__ */ new WeakMap();
let An = class {
  constructor(t, e, i) {
  ...
  get styleSheet() {
    ...
    if ($i && t === void 0) {
      ...
      i && (t = Mi.get(e)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), i && Mi.set(e, t));
    }
    return t;
  }
  toString() {
...
}, zi = $i ? (s) => s : (s) => s instanceof CSSStyleSheet ? ((t) => {
  let e = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ao, defineProperty: ro, getOwnPropertyDescriptor: so, getOwnPropertyNames: co, getOwnPropertySymbols: lo, getPrototypeOf: uo } = Object, _t = globalThis, Ni = _t.trustedTypes, ho = Ni ? Ni.emptyScript : "", Fe = _t.reactiveElementPolyfillSupport, Ht = (s, t) => s, si = { toAttribute(s, t) {
  switch (t) {
    case Boolean:
      s = s ? ho : null;
      break;
  ...
  return e;
} }, kn = (s, t) => !ao(s, t), Fi = { attribute: !0, type: String, converter: si, reflect: !1, useDefault: !1, hasChanged: kn };
...
let Et = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(Ht("properties"))) {
      const e = this.properties, i = [...co(e), ...lo(e)];
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const n of i) e.unshift(zi(n));
    } else t !== void 0 && e.push(zi(t));
    return e;
  }
  static _$Eu(t, e) {
    const i = e.attribute;
  ...
  _$ET(t, e) {
    ...
    if (n !== void 0 && i.reflect === !0) {
      const a = (((o = i.converter) == null ? void 0 : o.toAttribute) !== void 0 ? i.converter : si).toAttribute(e, i.type);
  ...
  _$AK(t, e) {
    ...
    if (n !== void 0 && this._$Em !== n) {
      const r = i.getPropertyOptions(n), c = typeof r.converter == "function" ? { fromAttribute: r.converter } : ((o = r.converter) == null ? void 0 : o.fromAttribute) !== void 0 ? r.converter : si;
      this._$Em = n;
  ...
  requestUpdate(t, e, i) {
    ...
    if (t !== void 0) {
      ...
      if (i ?? (i = o.getPropertyOptions(t)), !((i.hasChanged ?? kn)(a, e) || i.useDefault && i.reflect && a === ((n = this._$Ej) == null ? void 0 : n.get(t)) && !this.hasAttribute(o._$Eu(t, i)))) return;
      this.C(t, e, i);
    }
...
Et.elementStyles = [], Et.shadowRootOptions = { mode: "open" }, Et[Ht("elementProperties")] = /* @__PURE__ */ new Map(), Et[Ht("finalized")] = /* @__PURE__ */ new Map(), Fe == null || Fe({ ReactiveElement: Et }), (_t.reactiveElementVersions ?? (_t.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const qt = globalThis, Se = qt.trustedTypes, Bi = Se ? Se.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, Tn = "$lit$", ut = `lit$${Math.random().toFixed(9).slice(2)}$`, Rn = "?" + ut, po = `<${Rn}>`, $t = document, Jt = () => $t.createComment(""), Zt = (s) => s === null || typeof s != "object" && typeof s != "function", ki = Array.isArray, go = (s) => ki(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function", Be = `[ \t\n\f\r]`, Ft = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ji = /-->/g, Wi = />/g, mt = RegExp(`>|${Be}(?:([^\\s"'>=/]+)(${Be}*=${Be}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`, "g"), Ui = /'/g, Hi = /"/g, En = /^(?:script|style|textarea|title)$/i, _o = (s) => (t, ...e) => ({ _$litType$: s, strings: t, values: e }), g = _o(1), At = Symbol.for("lit-noChange"), B = Symbol.for("lit-nothing"), qi = /* @__PURE__ */ new WeakMap(), wt = $t.createTreeWalker($t, 129);
function Dn(s, t) {
  if (!ki(s) || !s.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return Bi !== void 0 ? Bi.createHTML(t) : t;
}
const fo = (s, t) => {
  const e = s.length - 1, i = [];
  let n, o = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", a = Ft;
  for (let r = 0; r < e; r++) {
    const c = s[r];
    let l, d, u = -1, h = 0;
    for (; h < c.length && (a.lastIndex = h, d = a.exec(c), d !== null); ) h = a.lastIndex, a === Ft ? d[1] === "!--" ? a = ji : d[1] !== void 0 ? a = Wi : d[2] !== void 0 ? (En.test(d[2]) && (n = RegExp("</" + d[2], "g")), a = mt) : d[3] !== void 0 && (a = mt) : a === mt ? d[0] === ">" ? (a = n ?? Ft, u = -1) : d[1] === void 0 ? u = -2 : (u = a.lastIndex - d[2].length, l = d[1], a = d[3] === void 0 ? mt : d[3] === '"' ? Hi : Ui) : a === Hi || a === Ui ? a = mt : a === ji || a === Wi ? a = Ft : (a = mt, n = void 0);
    const _ = a === mt && s[r + 1].startsWith("/>") ? " " : "";
    o += a === Ft ? c + po : u >= 0 ? (i.push(l), c.slice(0, u) + Tn + c.slice(u) + ut + _) : c + ut + (u === -2 ? r : _);
  }
  return [Dn(s, o + (s[e] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), i];
};
class te {
  constructor({ strings: t, _$litType$: e }, i) {
    ...
    this.parts = [];
    let o = 0, a = 0;
    const r = t.length - 1, c = this.parts, [l, d] = fo(t, e);
    if (this.el = te.createElement(l, i), wt.currentNode = this.el.content, e === 2 || e === 3) {
      const u = this.el.content.firstChild;
      u.replaceWith(...u.childNodes);
    }
    for (; (n = wt.nextNode()) !== null && c.length < r; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) for (const u of n.getAttributeNames()) if (u.endsWith(Tn)) {
          const h = d[a++], _ = n.getAttribute(u).split(ut), p = /([.?@])?(.*)/.exec(h);
          c.push({ type: 1, index: o, name: p[2], strings: _, ctor: p[1] === "." ? yo : p[1] === "?" ? vo : p[1] === "@" ? bo : Oe }), n.removeAttribute(u);
        } else u.startsWith(ut) && (c.push({ type: 6, index: o }), n.removeAttribute(u));
        if (En.test(n.tagName)) {
          const u = n.textContent.split(ut), h = u.length - 1;
          if (h > 0) {
            n.textContent = Se ? Se.emptyScript : "";
            for (let _ = 0; _ < h; _++) n.append(u[_], Jt()), wt.nextNode(), c.push({ type: 2, index: ++o });
            n.append(u[h], Jt());
          }
        }
      } else if (n.nodeType === 8) if (n.data === Rn) c.push({ type: 2, index: o });
      else {
        let u = -1;
        for (; (u = n.data.indexOf(ut, u + 1)) !== -1; ) c.push({ type: 7, index: o }), u += ut.length - 1;
      }
      o++;
    }
  }
...
function It(s, t, e = s, i) {
  ...
  const o = Zt(t) ? void 0 : t._$litDirective$;
  return (n == null ? void 0 : n.constructor) !== o && ((r = n == null ? void 0 : n._$AO) == null || r.call(n, !1), o === void 0 ? n = void 0 : (n = new o(s), n._$AT(s, e, i)), i !== void 0 ? (e._$Co ?? (e._$Co = []))[i] = n : e._$Cl = n), n !== void 0 && (t = It(s, n._$AS(s, t.values), n, i)), t;
}
let mo = class {
  constructor(t, e) {
  ...
  u(t) {
    const { el: { content: e }, parts: i } = this._$AD, n = ((t == null ? void 0 : t.creationScope) ?? $t).importNode(e, !0);
    wt.currentNode = n;
    let o = wt.nextNode(), a = 0, r = 0, c = i[0];
    for (; c !== void 0; ) {
      if (a === c.index) {
        let l;
        c.type === 2 ? l = new Mt(o, o.nextSibling, this, t) : c.type === 1 ? l = new c.ctor(o, c.name, c.strings, this, t) : c.type === 6 && (l = new xo(o, this, t)), this._$AV.push(l), c = i[++r];
      }
      a !== (c == null ? void 0 : c.index) && (o = wt.nextNode(), a++);
    }
    return wt.currentNode = $t, n;
  }
  p(t) {
    let e = 0;
...
class Mt {
  ...
  _$AI(t, e = this) {
    t = It(this, t, e), Zt(t) ? t === B || t == null || t === "" ? (this._$AH !== B && this._$AR(), this._$AH = B) : t !== this._$AH && t !== At && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : go(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== B && Zt(this._$AH) ? this._$AA.nextSibling.data = t : this.T($t.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var o;
    const { values: e, _$litType$: i } = t, n = typeof i == "number" ? this._$AC(t) : (i.el === void 0 && (i.el = te.createElement(Dn(i.h, i.h[0]), this.options)), i);
    if (((o = this._$AH) == null ? void 0 : o._$AD) === n) this._$AH.p(e);
    else {
      const a = new mo(n, this), r = a.u(this.options);
      a.p(e), this.T(r), this._$AH = a;
    }
  }
  _$AC(t) {
    let e = qi.get(t.strings);
    return e === void 0 && qi.set(t.strings, e = new te(t)), e;
  }
  k(t) {
    ki(this._$AH) || (this._$AH = [], this._$AR());
    const e = this._$AH;
    let i, n = 0;
    for (const o of t) n === e.length ? e.push(i = new Mt(this.O(Jt()), this.O(Jt()), this, this.options)) : i = e[n], i._$AI(o), n++;
...
class Oe {
  ...
  _$AI(t, e = this, i, n) {
    ...
    let a = !1;
    if (o === void 0) t = It(this, t, e, 0), a = !Zt(t) || t !== this._$AH && t !== At, a && (this._$AH = t);
    else {
      const r = t;
      let c, l;
      for (t = o[0], c = 0; c < o.length - 1; c++) l = It(this, r[i + c], e, c), l === At && (l = this._$AH[c]), a || (a = !Zt(l) || l !== this._$AH[c]), l === B ? t = B : t !== B && (t += (l ?? "") + o[c + 1]), this._$AH[c] = l;
    }
    a && !n && this.j(t);
  }
  j(t) {
...
class bo extends Oe {
  ...
  _$AI(t, e = this) {
    if ((t = It(this, t, e, 0) ?? B) === At) return;
...
const wo = { I: Mt }, je = qt.litHtmlPolyfillSupport;
je == null || je(te, Mt), (qt.litHtmlVersions ?? (qt.litHtmlVersions = [])).push("3.3.1");
const So = (s, t, e) => {
  const i = (e == null ? void 0 : e.renderBefore) ?? t;
  let n = i._$litPart$;
  if (n === void 0) {
    const o = (e == null ? void 0 : e.renderBefore) ?? null;
    i._$litPart$ = n = new Mt(t.insertBefore(Jt(), o), o, void 0, e ?? {});
  }
  return n._$AI(s), n;
};
/**
...
let ft = class extends Et {
  ...
  update(t) {
    const e = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = So(e, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var t;
...
var yn;
ft._$litElement$ = !0, ft.finalized = !0, (yn = St.litElementHydrateSupport) == null || yn.call(St, { LitElement: ft });
const We = St.litElementPolyfillSupport;
We == null || We({ LitElement: ft });
(St.litElementVersions ?? (St.litElementVersions = [])).push("4.2.1");
const Pe = oe`
  :host {
...
function $o(s) {
  ...
  return t === "floor" || t === "area" || t === "building" || t === "grounds" || t === "subarea" || t === "property" ? t : "area";
}
function z(s) {
  var t, e;
  return $o((e = (t = s.modules) == null ? void 0 : t._meta) == null ? void 0 : e.type);
}
function ci(s) {
...
function Ao(s, t) {
  return ci(s).includes(t);
}
function ko(s) {
  var c;
  const { locations: t, locationId: e, newParentId: i } = s;
  if (i === e || i && li(t, e, i)) return !1;
  ...
  if (a === "building" || a === "grounds") {
    if (i === null) return !0;
    const l = n.get(i);
    return l ? z(l) === "property" : !1;
  }
  const r = i === null ? "root" : z(n.get(i) ?? {});
  return !!Ao(a, r);
}
function li(s, t, e) {
  if (t === e) return !1;
...
const To = "managed_shadow", Ro = /* @__PURE__ */ new Set(["floor", "building", "grounds", "property"]), ae = (s) => {
  var t;
  return ((t = s == null ? void 0 : s.modules) == null ? void 0 : t._meta) || {};
}, re = (s, t) => {
  const e = s[t];
  return typeof e == "string" ? e.trim() : "";
}, Eo = (s) => re(ae(s), "role").toLowerCase(), Do = (s) => re(ae(s), "type").toLowerCase(), ee = (s = []) => {
  const t = /* @__PURE__ */ new Set();
  for (const e of s) {
    const i = ae(e), n = re(i, "shadow_area_id");
    n && Ro.has(Do(e)) && t.add(n);
  }
  return t;
}, ie = (s, t) => {
  if (!s) return !1;
  if (t != null && t.has(s.id))
    return !0;
  const e = ae(s);
  return !!(Eo(s) === To || re(e, "shadow_for_location_id"));
}, Ue = (s) => {
  if (!s) return "";
  const t = ae(s);
  return re(t, "shadow_area_id");
};
function Ti(s) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Co = { CHILD: 2 }, Lo = (s) => (...t) => ({ _$litDirective$: s, values: t });
class Io {
  constructor(t) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: Oo } = wo, Gi = () => document.createComment(""), Bt = (s, t, e) => {
  var o;
  const i = s._$AA.parentNode, n = t === void 0 ? s._$AB : t._$AA;
  if (e === void 0) {
    const a = i.insertBefore(Gi(), n), r = i.insertBefore(Gi(), n);
  ...
  return e;
}, yt = (s, t, e = s) => (s._$AI(t, e), s), Po = {}, Mo = (s, t = Po) => s._$AH = t, zo = (s) => s._$AH, He = (s) => {
...
const Vi = (s, t, e) => {
  ...
  return i;
}, me = Lo(class extends Io {
  constructor(s) {
    if (super(s), s.type !== Co.CHILD) throw Error("repeat() can only be used in text expressions");
  }
  dt(s, t, e) {
    let i;
  ...
  update(s, [t, e, i]) {
    const n = zo(s), { values: o, keys: a } = this.dt(t, e, i);
    if (!Array.isArray(n)) return this.ut = a, o;
    const r = this.ut ?? (this.ut = []), c = [];
    let l, d, u = 0, h = n.length - 1, _ = 0, p = o.length - 1;
    for (; u <= h && _ <= p; ) if (n[u] === null) u++;
    else if (n[h] === null) h--;
    else if (r[u] === a[_]) c[_] = yt(n[u], o[_]), u++, _++;
    else if (r[h] === a[p]) c[p] = yt(n[h], o[p]), h--, p--;
    else if (r[u] === a[p]) c[p] = yt(n[u], o[p]), Bt(s, c[p + 1], n[u]), u++, p--;
    else if (r[h] === a[_]) c[_] = yt(n[h], o[_]), Bt(s, n[u], n[h]), h--, _++;
    else if (l === void 0 && (l = Vi(a, _, p), d = Vi(r, u, h)), l.has(r[u])) if (l.has(r[h])) {
      const f = d.get(a[_]), m = f !== void 0 ? n[f] : null;
      if (m === null) {
        const y = Bt(s, n[u]);
        yt(y, o[_]), c[_] = y;
      } else c[_] = yt(m, o[_]), Bt(s, n[u], m), n[f] = null;
      _++;
    } else He(n[h]), h--;
    else He(n[u]), u++;
    for (; _ <= p; ) {
...
function at(s) {
  for (var t = 1; t < arguments.length; t++) {
    ...
    t % 2 ? Ki(Object(e), !0).forEach(function(i) {
      No(s, i, e[i]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(s, Object.getOwnPropertyDescriptors(e)) : Ki(Object(e)).forEach(function(i) {
...
var ct = rt(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i), se = rt(/Edge/i), Yi = rt(/firefox/i), Gt = rt(/safari/i) && !rt(/chrome/i) && !rt(/android/i), Ri = rt(/iP(ad|od|hone)/i), Cn = rt(/chrome/i) && rt(/android/i), Ln = {
  capture: !1,
  passive: !1
};
function E(s, t, e) {
  s.addEventListener(t, e, !ct && Ln);
}
function R(s, t, e) {
  s.removeEventListener(t, e, !ct && Ln);
}
function $e(s, t) {
  if (t) {
...
function et(s, t, e, i) {
  if (s) {
    e = e || document;
    do {
      if (t != null && (t[0] === ">" ? s.parentNode === e && $e(s, t) : $e(s, t)) || i && s === e)
        return s;
      if (s === e) break;
    } while (s = In(s));
  }
...
function Y(s, t, e) {
  if (s && t)
    if (s.classList)
      ...
      var i = (" " + s.className + " ").replace(Xi, " ").replace(" " + t + " ", " ");
      s.className = (i + (e ? " " + t : "")).replace(Xi, " ");
    }
}
function S(s, t, e) {
  var i = s && s.style;
...
function F(s, t, e, i, n) {
  if (!(!s.getBoundingClientRect && s !== window)) {
    var o, a, r, c, l, d, u;
    if (s !== window && s.parentNode && s !== ot() ? (o = s.getBoundingClientRect(), a = o.top, r = o.left, c = o.bottom, l = o.right, d = o.height, u = o.width) : (a = 0, r = 0, c = window.innerHeight, l = window.innerWidth, d = window.innerHeight, u = window.innerWidth), (t || e) && s !== window && (n = n || s.parentNode, !ct))
      do
        if (n && n.getBoundingClientRect && (S(n, "transform") !== "none" || e && S(n, "position") !== "static")) {
          var h = n.getBoundingClientRect();
          a -= h.top + parseInt(S(n, "border-top-width")), r -= h.left + parseInt(S(n, "border-left-width")), c = a + o.height, l = r + o.width;
          break;
        }
      while (n = n.parentNode);
    if (i && s !== window) {
      var _ = Lt(n || s), p = _ && _.a, f = _ && _.d;
      _ && (a /= f, r /= p, u /= p, d /= f, c = a + d, l = r + u);
    }
    return {
      top: a,
      left: r,
...
function Ot(s, t, e, i) {
  for (var n = 0, o = 0, a = s.children; o < a.length; ) {
    if (a[o].style.display !== "none" && a[o] !== $.ghost && (i || a[o] !== $.dragged) && et(a[o], e.draggable, s, !1)) {
      if (n === t)
        return a[o];
      n++;
    }
...
function Ei(s, t) {
  for (var e = s.lastElementChild; e && (e === $.ghost || S(e, "display") === "none" || t && !$e(e, t)); )
...
function J(s, t) {
  ...
  for (; s = s.previousElementSibling; )
    s.nodeName.toUpperCase() !== "TEMPLATE" && s !== $.clone && (!t || $e(s, t)) && e++;
  return e;
}
function Ji(s) {
  var t = 0, e = 0, i = ot();
...
function gt(s, t) {
  if (!s || !s.getBoundingClientRect) return ot();
  var e = s, i = !1;
  do
    if (e.clientWidth < e.scrollWidth || e.clientHeight < e.scrollHeight) {
      ...
      if (e.clientWidth < e.scrollWidth && (n.overflowX == "auto" || n.overflowX == "scroll") || e.clientHeight < e.scrollHeight && (n.overflowY == "auto" || n.overflowY == "scroll")) {
        if (!e.getBoundingClientRect || e === document.body) return ot();
        if (i || t) return e;
        i = !0;
      }
    }
...
function Pn(s, t) {
  return function() {
    if (!Vt) {
      ...
      e.length === 1 ? s.call(i, e[0]) : s.apply(i, e), Vt = setTimeout(function() {
        Vt = void 0;
      }, t);
    }
  };
...
function Nn(s, t, e) {
  ...
  return Array.from(s.children).forEach(function(n) {
    var o, a, r, c;
    if (!(!et(n, t.draggable, s, !1) || n.animated || n === e)) {
      var l = F(n);
  ...
  return {
    captureAnimationState: function() {
      if (s = [], !!this.options.animation) {
        ...
        i.forEach(function(n) {
          if (!(S(n, "display") === "none" || n === $.ghost)) {
            s.push({
              target: n,
              rect: F(n)
            });
            var o = at({}, s[s.length - 1].rect);
    ...
    animateAll: function(i) {
      ...
      s.forEach(function(r) {
        var c = 0, l = r.target, d = l.fromRect, u = F(l), h = l.prevFromRect, _ = l.prevToRect, p = r.rect, f = Lt(l, !0);
        f && (u.top -= f.f, u.left -= f.e), l.toRect = u, l.thisAnimationDuration && qe(h, u) && !qe(d, u) && // Make sure animatingRect is on line between toRect & fromRect
        (p.top - u.top) / (p.left - u.left) === (d.top - u.top) / (d.left - u.left) && (c = Vo(p, h, _, n.options)), qe(u, d) || (l.prevFromRect = d, l.prevToRect = u, c || (c = n.options.animation), n.animate(l, p, u, c)), c && (o = !0, a = Math.max(a, c), clearTimeout(l.animationResetTimer), l.animationResetTimer = setTimeout(function() {
    ...
    animate: function(i, n, o, a) {
      if (a) {
        ...
        var r = Lt(this.el), c = r && r.a, l = r && r.d, d = (n.left - o.left) / (c || 1), u = (n.top - o.top) / (l || 1);
        i.animatingX = !!d, i.animatingY = !!u, S(i, "transform", "translate3d(" + d + "px," + u + "px,0)"), this.forRepaintDummy = Go(i), S(i, "transition", "transform " + a + "ms" + (this.options.easing ? " " + this.options.easing : "")), S(i, "transform", "translate3d(0,0,0)"), typeof i.animated == "number" && clearTimeout(i.animated), i.animated = setTimeout(function() {
          S(i, "transition", ""), S(i, "transform", ""), i.animated = !1, i.animatingX = !1, i.animatingY = !1;
        }, a);
      }
    }
  };
...
var Tt = [], Ge = {
  ...
  mount: function(t) {
    for (var e in Ge)
      Ge.hasOwnProperty(e) && !(e in t) && (t[e] = Ge[e]);
  ...
  pluginEvent: function(t, e, i) {
    ...
    Tt.forEach(function(a) {
      e[a.pluginName] && (e[a.pluginName][o] && e[a.pluginName][o](at({
        sortable: e
      }, i)), e.options[a.pluginName] && e[a.pluginName][t] && e[a.pluginName][t](at({
        sortable: e
      }, i)));
    });
  },
  initializePlugins: function(t, e, i, n) {
    Tt.forEach(function(r) {
      ...
      if (!(!t.options[c] && !r.initializeByDefault)) {
        ...
        l.sortable = t, l.options = t.options, t[c] = l, st(i, l.defaults);
      }
    });
  ...
  getEventProperties: function(t, e) {
    ...
    return Tt.forEach(function(n) {
      typeof n.eventProperties == "function" && st(i, n.eventProperties.call(e[n.pluginName], t));
    }), i;
  },
...
function Ko(s) {
  ...
  if (t = t || e && e[V], !!t) {
    ...
    window.CustomEvent && !ct && !se ? f = new CustomEvent(i, {
      bubbles: !0,
      cancelable: !0
    }) : (f = document.createEvent("Event"), f.initEvent(i, !0, !0)), f.to = a || e, f.from = r || e, f.item = n || e, f.clone = o, f.oldIndex = c, f.newIndex = l, f.oldDraggableIndex = d, f.newDraggableIndex = u, f.originalEvent = h, f.pullMode = _ ? _.lastPutMode : void 0;
    var A = at(at({}, p), ce.getEventProperties(i, t));
    for (var w in A)
      f[w] = A[w];
    e && e.dispatchEvent(f), m[y] && m[y].call(t, f);
  }
}
var Yo = ["evt"], G = function(t, e) {
  var i = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, n = i.evt, o = Bo(i, Yo);
  ce.pluginEvent.bind($)(t, e, at({
    dragEl: v,
    parentEl: M,
    ghostEl: k,
    rootEl: O,
...
var v, M, k, O, xt, ve, P, ht, Ct, X, Kt, dt, de, j, Dt = !1, Ae = !1, ke = [], vt, tt, Ve, Ke, Zi, tn, jt, Rt, Yt, Xt = !1, ue = !1, be, U, Ye = [], di = !1, Te = [], Me = typeof document < "u", he = Ri, en = se || ct ? "cssFloat" : "float", Xo = Me && !Cn && !Ri && "draggable" in document.createElement("div"), Fn = function() {
  if (Me) {
    if (ct)
      return !1;
  ...
  var i = S(t), n = parseInt(i.width) - parseInt(i.paddingLeft) - parseInt(i.paddingRight) - parseInt(i.borderLeftWidth) - parseInt(i.borderRightWidth), o = Ot(t, 0, e), a = Ot(t, 1, e), r = o && S(o), c = a && S(a), l = r && parseInt(r.marginLeft) + parseInt(r.marginRight) + F(o).width, d = c && parseInt(c.marginLeft) + parseInt(c.marginRight) + F(a).width;
  if (i.display === "flex")
  ...
  return o && (r.display === "block" || r.display === "flex" || r.display === "table" || r.display === "grid" || l >= n && i[en] === "none" || a && i[en] === "none" && l + d > n) ? "vertical" : "horizontal";
}, Qo = function(t, e, i) {
  ...
  function e(o, a) {
    return function(r, c, l, d) {
      var u = r.options.group.name && c.options.group.name && r.options.group.name === c.options.group.name;
      if (o == null && (a || u))
        return !0;
      if (o == null || o === !1)
        return !1;
  ...
  !Fn && k && S(k, "display", "none");
}, Un = function() {
  !Fn && k && S(k, "display", "");
};
Me && !Cn && document.addEventListener("click", function(s) {
  if (Ae)
    return s.preventDefault(), s.stopPropagation && s.stopPropagation(), s.stopImmediatePropagation && s.stopImmediatePropagation(), Ae = !1, !1;
}, !0);
var bt = function(t) {
  if (v) {
    t = t.touches ? t.touches[0] : t;
    var e = Jo(t.clientX, t.clientY);
    if (e) {
      var i = {};
      for (var n in t)
...
function $(s, t) {
  ...
  this.el = s, this.options = t = st({}, t), s[V] = this;
  var e = {
    group: null,
    sort: !0,
    disabled: !1,
    ...
    supportPointer: $.supportPointer !== !1 && "PointerEvent" in window && (!Gt || Ri),
    emptyInsertThreshold: 5
  };
  ce.initializePlugins(this, s, e);
  for (var i in e)
    !(i in t) && (t[i] = e[i]);
  jn(t);
  for (var n in this)
    n.charAt(0) === "_" && typeof this[n] == "function" && (this[n] = this[n].bind(this));
  this.nativeDraggable = t.forceFallback ? !1 : Xo, this.nativeDraggable && (this.options.touchStartThreshold = 1), t.supportPointer ? E(s, "pointerdown", this._onTapStart) : (E(s, "mousedown", this._onTapStart), E(s, "touchstart", this._onTapStart)), this.nativeDraggable && (E(s, "dragover", this), E(s, "dragenter", this)), ke.push(this.el), t.store && t.store.get && this.sort(t.store.get(this) || []), st(this, qo());
}
$.prototype = /** @lends Sortable.prototype */
{
  ...
  _onTapStart: function(t) {
    if (t.cancelable) {
      ...
      if (sa(i), !v && !(/mousedown|pointerdown/.test(a) && t.button !== 0 || n.disabled) && !l.isContentEditable && !(!this.nativeDraggable && Gt && c && c.tagName.toUpperCase() === "SELECT") && (c = et(c, n.draggable, i, !1), !(c && c.animated) && ve !== c)) {
        if (Ct = J(c), Kt = J(c, n.draggable), typeof d == "function") {
        ...
        n.handle && !et(l, n.handle, i, !1) || this._prepareDragStart(t, r, c);
      }
    }
  },
  _prepareDragStart: function(t, e, i) {
    ...
    if (i && !v && i.parentNode === o) {
      var l = F(i);
      if (O = o, v = i, M = v.parentNode, xt = v.nextSibling, ve = i, de = a.group, $.dragged = v, vt = {
        target: v,
        clientX: (e || t).clientX,
        clientY: (e || t).clientY
      }, Zi = vt.clientX - l.left, tn = vt.clientY - l.top, this._lastX = (e || t).clientX, this._lastY = (e || t).clientY, v.style["will-change"] = "all", c = function() {
        if (G("delayEnded", n, {
          evt: t
        }), $.eventCanceled) {
          n._onDrop();
        ...
        n._disableDelayedDragEvents(), !Yi && n.nativeDraggable && (v.draggable = !0), n._triggerDragStart(t, e), H({
          sortable: n,
          name: "choose",
          originalEvent: t
        }), Y(v, a.chosenClass, !0);
        ...
        On(v, d.trim(), Xe);
      }), E(r, "dragover", bt), E(r, "mousemove", bt), E(r, "touchmove", bt), a.supportPointer ? (E(r, "pointerup", n._onDrop), !this.nativeDraggable && E(r, "pointercancel", n._onDrop)) : (E(r, "mouseup", n._onDrop), E(r, "touchend", n._onDrop), E(r, "touchcancel", n._onDrop)), Yi && this.nativeDraggable && (this.options.touchStartThreshold = 4, v.draggable = !0), G("delayStart", this, {
        evt: t
      }), a.delay && (!a.delayOnTouchOnly || e) && (!this.nativeDraggable || !(se || ct))) {
        if ($.eventCanceled) {
          this._onDrop();
          return;
        }
  ...
  _disableDelayedDrag: function() {
    v && Xe(v), clearTimeout(this._dragStartTimer), this._disableDelayedDragEvents();
  },
  _disableDelayedDragEvents: function() {
    var t = this.el.ownerDocument;
    R(t, "mouseup", this._disableDelayedDrag), R(t, "touchend", this._disableDelayedDrag), R(t, "touchcancel", this._disableDelayedDrag), R(t, "pointerup", this._disableDelayedDrag), R(t, "pointercancel", this._disableDelayedDrag), R(t, "mousemove", this._delayedDragTouchMoveHandler), R(t, "touchmove", this._delayedDragTouchMoveHandler), R(t, "pointermove", this._delayedDragTouchMoveHandler);
  },
  _triggerDragStart: function(t, e) {
    e = e || t.pointerType == "touch" && t, !this.nativeDraggable || e ? this.options.supportPointer ? E(document, "pointermove", this._onTouchMove) : e ? E(document, "touchmove", this._onTouchMove) : E(document, "mousemove", this._onTouchMove) : (E(v, "dragend", this), E(O, "dragstart", this._onDragStart));
    try {
  ...
  _dragStarted: function(t, e) {
    if (Dt = !1, O && v) {
      G("dragStarted", this, {
        evt: e
      }), this.nativeDraggable && E(document, "dragover", Zo);
      var i = this.options;
      !t && Y(v, i.dragClass, !1), Y(v, i.ghostClass, !0), $.active = this, t && this._appendGhost(), H({
        sortable: this,
        name: "start",
        originalEvent: e
      });
  ...
  _emulateDragOver: function() {
    if (tt) {
      this._lastX = tt.clientX, this._lastY = tt.clientY, Wn();
      for (var t = document.elementFromPoint(tt.clientX, tt.clientY), e = t; t && t.shadowRoot && (t = t.shadowRoot.elementFromPoint(tt.clientX, tt.clientY), t !== e); )
        e = t;
  ...
  _onTouchMove: function(t) {
    if (vt) {
      var e = this.options, i = e.fallbackTolerance, n = e.fallbackOffset, o = t.touches ? t.touches[0] : t, a = k && Lt(k, !0), r = k && a && a.a, c = k && a && a.d, l = he && U && Ji(U), d = (o.clientX - vt.clientX + n.x) / (r || 1) + (l ? l[0] - Ye[0] : 0) / (r || 1), u = (o.clientY - vt.clientY + n.y) / (c || 1) + (l ? l[1] - Ye[1] : 0) / (c || 1);
      if (!$.active && !Dt) {
      ...
      if (k) {
        ...
        S(k, "webkitTransform", h), S(k, "mozTransform", h), S(k, "msTransform", h), S(k, "transform", h), Ve = d, Ke = u, tt = o;
      }
  ...
  _appendGhost: function() {
    if (!k) {
      var t = this.options.fallbackOnBody ? document.body : O, e = F(v, !0, he, !0, t), i = this.options;
      if (he) {
        for (U = t; S(U, "position") === "static" && S(U, "transform") === "none" && U !== document; )
          U = U.parentNode;
        U !== document.body && U !== document.documentElement ? (U === document && (U = ot()), e.top += U.scrollTop, e.left += U.scrollLeft) : U = ot(), Ye = Ji(U);
      }
      k = v.cloneNode(!0), Y(k, i.ghostClass, !1), Y(k, i.fallbackClass, !0), Y(k, i.dragClass, !0), S(k, "transition", ""), S(k, "transform", ""), S(k, "box-sizing", "border-box"), S(k, "margin", 0), S(k, "top", e.top), S(k, "left", e.left), S(k, "width", e.width), S(k, "height", e.height), S(k, "opacity", "0.8"), S(k, "position", he ? "absolute" : "fixed"), S(k, "zIndex", "100000"), S(k, "pointerEvents", "none"), $.ghost = k, t.appendChild(k), S(k, "transform-origin", Zi / parseInt(k.style.width) * 100 + "% " + tn / parseInt(k.style.height) * 100 + "%");
    }
  },
  _onDragStart: function(t, e) {
    ...
    G("setupClone", this), $.eventCanceled || (P = zn(v), P.removeAttribute("id"), P.draggable = !1, P.style["will-change"] = "", this._hideClone(), Y(P, this.options.chosenClass, !1), $.clone = P), i.cloneId = xe(function() {
      G("clone", i), !$.eventCanceled && (i.options.removeCloneOnHide || O.insertBefore(P, v), i._hideClone(), H({
        sortable: i,
        name: "clone"
      }));
    }), !e && Y(v, o.dragClass, !0), e ? (Ae = !0, i._loopId = setInterval(i._emulateDragOver, 50)) : (R(document, "mouseup", i._onDrop), R(document, "touchend", i._onDrop), R(document, "touchcancel", i._onDrop), n && (n.effectAllowed = "move", o.setData && o.setData.call(i, n, v)), E(document, "drop", i), S(v, "transform", "translateZ(0)")), Dt = !0, i._dragStartId = xe(i._dragStarted.bind(i, e, t)), E(document, "selectstart", i), jt = !0, window.getSelection().removeAllRanges(), Gt && S(document.body, "user-select", "none");
  },
  // Returns true - if no further action is needed (either inserted or another condition)
  _onDragOver: function(t) {
    var e = this.el, i = t.target, n, o, a, r = this.options, c = r.group, l = $.active, d = de === c, u = r.sort, h = j || l, _, p = this, f = !1;
    if (di) return;
    function m(Nt, eo) {
      G(Nt, p, at({
        evt: t,
        ...
        target: i,
        completed: A,
        onMove: function(Pi, io) {
          return pe(O, e, v, n, Pi, F(Pi), t, io);
        },
        changed: w
      }, eo));
    }
    ...
    function A(Nt) {
      return m("dragOverCompleted", {
        insertion: Nt
      }), Nt && (d ? l._hideClone() : l._showClone(p), p !== h && (Y(v, j ? j.options.ghostClass : l.options.ghostClass, !1), Y(v, r.ghostClass, !0)), j !== p && p !== $.active ? j = p : p === $.active && j && (j = null), h === p && (p._ignoreWhileAnimating = i), p.animateAll(function() {
        m("dragOverAnimationComplete"), p._ignoreWhileAnimating = null;
      }), p !== h && (h.animateAll(), h._ignoreWhileAnimating = null)), (i === v && !v.animated || i === e && !i.animated) && (Rt = null), !r.dragoverBubble && !t.rootEl && i !== document && (v.parentNode[V]._isOutsideThisEl(t.target), !Nt && bt(t)), !r.dragoverBubble && t.stopPropagation && t.stopPropagation(), f = !0;
    }
    function w() {
      X = J(v), dt = J(v, r.draggable), H({
        sortable: p,
        name: "change",
        toEl: e,
        newIndex: X,
    ...
    if (t.preventDefault !== void 0 && t.cancelable && t.preventDefault(), i = et(i, r.draggable, e, !0), m("dragOver"), $.eventCanceled) return f;
    if (v.contains(t.target) || i.animated && i.animatingX && i.animatingY || p._ignoreWhileAnimating === i)
      return A(!1);
    if (Ae = !1, l && !r.disabled && (d ? u || (a = M !== O) : j === this || (this.lastPutMode = de.checkPull(this, l, v, t)) && c.checkPut(this, l, v, t))) {
      if (_ = this._getDirection(t, i) === "vertical", n = F(v), m("dragOverValid"), $.eventCanceled) return f;
      if (a)
        return M = O, y(), this._hideClone(), m("revert"), $.eventCanceled || (xt ? O.insertBefore(v, xt) : O.appendChild(v)), A(!0);
      var b = Ei(e, r.draggable);
      if (!b || na(t, _, this) && !b.animated) {
        if (b === v)
          return A(!1);
        if (b && e === t.target && (i = b), i && (o = F(i)), pe(O, e, v, n, i, o, t, !!i) !== !1)
          return y(), b && b.nextSibling ? e.insertBefore(v, b.nextSibling) : e.appendChild(v), M = e, w(), A(!0);
      } else if (b && ia(t, _, this)) {
        var C = Ot(e, 0, r, !0);
        if (C === v)
          return A(!1);
        if (i = C, o = F(i), pe(O, e, v, n, i, o, t, !1) !== !1)
          return y(), e.insertBefore(v, C), M = e, w(), A(!0);
      } else if (i.parentNode === e) {
        o = F(i);
        var I = 0, L, T = v.parentNode !== e, x = !Qo(v.animated && v.toRect || n, i.animated && i.toRect || o, _), D = _ ? "top" : "left", W = Qi(i, "top", "top") || Qi(v, "top", "top"), K = W ? W.scrollTop : void 0;
        Rt !== i && (L = o[D], Xt = !1, ue = !x && r.invertSwap || T), I = oa(t, i, o, _, x ? 1 : r.swapThreshold, r.invertedSwapThreshold == null ? r.swapThreshold : r.invertedSwapThreshold, ue, Rt === i);
        var q;
        if (I !== 0) {
          var Q = J(v);
          do
            Q -= I, q = M.children[Q];
          while (q && (S(q, "display") === "none" || q === k));
        }
        if (I === 0 || q === i)
          return A(!1);
        Rt = i, Yt = I;
        var Z = i.nextElementSibling, lt = !1;
        lt = I === 1;
        var le = pe(O, e, v, n, i, o, t, lt);
        if (le !== !1)
          return (le === 1 || le === -1) && (lt = le === 1), di = !0, setTimeout(ea, 30), y(), lt && !Z ? e.appendChild(v) : i.parentNode.insertBefore(v, lt ? Z : i), W && Mn(W, 0, K - W.scrollTop), M = v.parentNode, L !== void 0 && !ue && (be = Math.abs(L - F(i)[D])), w(), A(!0);
      }
      if (e.contains(v))
        return A(!1);
    }
  ...
  _offMoveEvents: function() {
    R(document, "mousemove", this._onTouchMove), R(document, "touchmove", this._onTouchMove), R(document, "pointermove", this._onTouchMove), R(document, "dragover", bt), R(document, "mousemove", bt), R(document, "touchmove", bt);
  },
  _offUpEvents: function() {
    var t = this.el.ownerDocument;
    R(t, "mouseup", this._onDrop), R(t, "touchend", this._onDrop), R(t, "pointerup", this._onDrop), R(t, "pointercancel", this._onDrop), R(t, "touchcancel", this._onDrop), R(document, "selectstart", this);
  },
  _onDrop: function(t) {
    var e = this.el, i = this.options;
    if (X = J(v), dt = J(v, i.draggable), G("drop", this, {
      evt: t
    }), M = v && v.parentNode, X = J(v), dt = J(v, i.draggable), $.eventCanceled) {
      this._nulling();
      return;
    }
    Dt = !1, ue = !1, Xt = !1, clearInterval(this._loopId), clearTimeout(this._dragStartTimer), ui(this.cloneId), ui(this._dragStartId), this.nativeDraggable && (R(document, "drop", this), R(e, "dragstart", this._onDragStart)), this._offMoveEvents(), this._offUpEvents(), Gt && S(document.body, "user-select", ""), S(v, "transform", ""), t && (jt && (t.cancelable && t.preventDefault(), !i.dropBubble && t.stopPropagation()), k && k.parentNode && k.parentNode.removeChild(k), (O === M || j && j.lastPutMode !== "clone") && P && P.parentNode && P.parentNode.removeChild(P), v && (this.nativeDraggable && R(v, "dragend", this), Xe(v), v.style["will-change"] = "", jt && !Dt && Y(v, j ? j.options.ghostClass : this.options.ghostClass, !1), Y(v, this.options.chosenClass, !1), H({
      sortable: this,
      name: "unchoose",
      toEl: M,
      newIndex: null,
      ...
      toEl: M,
      originalEvent: t
    })), $.active && ((X == null || X === -1) && (X = Ct, dt = Kt), H({
      sortable: this,
      name: "end",
      toEl: M,
      originalEvent: t
  ...
  _nulling: function() {
    G("nulling", this), O = v = M = k = xt = P = ve = ht = vt = tt = jt = X = dt = Ct = Kt = Rt = Yt = j = de = $.dragged = $.ghost = $.clone = $.active = null, Te.forEach(function(t) {
      t.checked = !0;
    }), Te.length = Ve = Ke = 0;
  },
  ...
  toArray: function() {
    for (var t = [], e, i = this.el.children, n = 0, o = i.length, a = this.options; n < o; n++)
      e = i[n], et(e, a.draggable, this.el, !1) && t.push(e.getAttribute(a.dataIdAttr) || ra(e));
    return t;
  },
  /**
  ...
  sort: function(t, e) {
    ...
    this.toArray().forEach(function(o, a) {
      var r = n.children[a];
      et(r, this.options.draggable, n, !1) && (i[o] = r);
  ...
  closest: function(t, e) {
    return et(t, e || this.options.draggable, this.el, !1);
  },
  /**
   * Set/get option
   * @param   {string} name
  ...
  option: function(t, e) {
    ...
    if (e === void 0)
      return i[t];
    var n = ce.modifyOption(this, t, e);
    typeof n < "u" ? i[t] = n : i[t] = e, t === "group" && jn(i);
  },
  /**
   * Destroy
   */
  destroy: function() {
    G("destroy", this);
    var t = this.el;
    t[V] = null, R(t, "mousedown", this._onTapStart), R(t, "touchstart", this._onTapStart), R(t, "pointerdown", this._onTapStart), this.nativeDraggable && (R(t, "dragover", this), R(t, "dragenter", this)), Array.prototype.forEach.call(t.querySelectorAll("[draggable]"), function(e) {
      e.removeAttribute("draggable");
    }), this._onDrop(), this._disableDelayedDragEvents(), ke.splice(ke.indexOf(this.el), 1), this.el = t = null;
  },
  _hideClone: function() {
    if (!ht) {
      if (G("hideClone", this), $.eventCanceled) return;
      S(P, "display", "none"), this.options.removeCloneOnHide && P.parentNode && P.parentNode.removeChild(P), ht = !0;
    }
  },
  _showClone: function(t) {
    ...
    if (ht) {
      if (G("showClone", this), $.eventCanceled) return;
      v.parentNode == O && !this.options.group.revertClone ? O.insertBefore(P, v) : xt ? O.insertBefore(P, xt) : O.appendChild(P), this.options.group.revertClone && this.animate(v, P), S(P, "display", ""), ht = !1;
    }
  }
};
function ta(s) {
...
function pe(s, t, e, i, n, o, a, r) {
  var c, l = s[V], d = l.options.onMove, u;
  return window.CustomEvent && !ct && !se ? c = new CustomEvent("move", {
    bubbles: !0,
    cancelable: !0
  }) : (c = document.createEvent("Event"), c.initEvent("move", !0, !0)), c.to = t, c.from = s, c.dragged = e, c.draggedRect = i, c.related = n || t, c.relatedRect = o || F(t), c.willInsertAfter = r, c.originalEvent = a, s.dispatchEvent(c), d && (u = d.call(l, c, a)), u;
}
function Xe(s) {
  s.draggable = !1;
}
...
function ia(s, t, e) {
  var i = F(Ot(e.el, 0, e.options, !0)), n = Nn(e.el, e.options, k), o = 10;
  return t ? s.clientX < n.left - o || s.clientY < i.top && s.clientX < i.right : s.clientY < n.top - o || s.clientY < i.bottom && s.clientX < i.left;
}
function na(s, t, e) {
  var i = F(Ei(e.el, e.options.draggable)), n = Nn(e.el, e.options, k), o = 10;
  return t ? s.clientX > n.right + o || s.clientY > i.bottom && s.clientX > i.left : s.clientY > n.bottom + o || s.clientX > i.right && s.clientY > i.top;
}
function oa(s, t, e, i, n, o, a, r) {
  var c = i ? s.clientY : s.clientX, l = i ? e.height : e.width, d = i ? e.top : e.left, u = i ? e.bottom : e.right, h = !1;
  if (!a) {
    if (r && be < l * n) {
      if (!Xt && (Yt === 1 ? c > d + l * o / 2 : c < u - l * o / 2) && (Xt = !0), Xt)
        h = !0;
      else if (Yt === 1 ? c < d + be : c > u - be)
        return -Yt;
...
Me && E(document, "touchmove", function(s) {
  ($.active || Dt) && s.cancelable && s.preventDefault();
});
$.utils = {
  on: E,
  off: R,
...
$.mount = function() {
  ...
  t[0].constructor === Array && (t = t[0]), t.forEach(function(i) {
    ...
    i.utils && ($.utils = at(at({}, $.utils), i.utils)), ce.mount(i);
  });
};
$.create = function(s, t) {
  return new $(s, t);
...
function ca() {
  ...
  return s.prototype = {
    ...
    drop: function() {
      this.sortable.nativeDraggable ? R(document, "dragover", this._handleAutoScroll) : (R(document, "pointermove", this._handleFallbackAutoScroll), R(document, "touchmove", this._handleFallbackAutoScroll), R(document, "mousemove", this._handleFallbackAutoScroll)), nn(), we(), Ho();
    },
    nulling: function() {
      Re = hi = Wt = pi = Ut = Qe = Je = null, N.length = 0;
    },
    ...
    _handleAutoScroll: function(e, i) {
      ...
      if (Re = e, i || this.options.forceAutoScrollFallback || se || ct || Gt) {
        Ze(e, this.options, r, i);
        var c = gt(r, !0);
        pi && (!Ut || o !== Qe || a !== Je) && (Ut && nn(), Ut = setInterval(function() {
          var l = gt(document.elementFromPoint(o, a), !0);
          l !== c && (c = l, we()), Ze(e, n.options, l, i);
        }, 10), Qe = o, Je = a);
      } else {
        if (!this.options.bubbleScroll || gt(r, !0) === ot()) {
          we();
          return;
        }
        Ze(e, this.options, gt(r, !1), !1);
      }
    }
  }, st(s, {
    pluginName: "scroll",
...
var Ze = Pn(function(s, t, e, i) {
  if (t.scroll) {
    var n = (s.touches ? s.touches[0] : s).clientX, o = (s.touches ? s.touches[0] : s).clientY, a = t.scrollSensitivity, r = t.scrollSpeed, c = ot(), l = !1, d;
    hi !== e && (hi = e, we(), Wt = t.scroll, d = t.scrollFn, Wt === !0 && (Wt = gt(e, !0)));
    var u = 0, h = Wt;
    do {
      var _ = h, p = F(_), f = p.top, m = p.bottom, y = p.left, A = p.right, w = p.width, b = p.height, C = void 0, I = void 0, L = _.scrollWidth, T = _.scrollHeight, x = S(_), D = _.scrollLeft, W = _.scrollTop;
      _ === c ? (C = w < L && (x.overflowX === "auto" || x.overflowX === "scroll" || x.overflowX === "visible"), I = b < T && (x.overflowY === "auto" || x.overflowY === "scroll" || x.overflowY === "visible")) : (C = w < L && (x.overflowX === "auto" || x.overflowX === "scroll"), I = b < T && (x.overflowY === "auto" || x.overflowY === "scroll"));
      var K = C && (Math.abs(A - n) <= a && D + w < L) - (Math.abs(y - n) <= a && !!D), q = I && (Math.abs(m - o) <= a && W + b < T) - (Math.abs(f - o) <= a && !!W);
      if (!N[u])
        for (var Q = 0; Q <= u; Q++)
          N[Q] || (N[Q] = {});
      (N[u].vx != K || N[u].vy != q || N[u].el !== _) && (N[u].el = _, N[u].vx = K, N[u].vy = q, clearInterval(N[u].pid), (K != 0 || q != 0) && (l = !0, N[u].pid = setInterval((function() {
        i && this.layer === 0 && $.active._onTouchMove(Re);
        var Z = N[this.layer].vy ? N[this.layer].vy * r : 0, lt = N[this.layer].vx ? N[this.layer].vx * r : 0;
        typeof d == "function" && d.call($.dragged.parentNode[V], lt, Z, s, Re, N[this.layer].el) !== "continue" || Mn(N[this.layer].el, lt, Z);
      }).bind({
        layer: u
      }), 24))), u++;
    } while (t.bubbleScroll && h !== c && (h = gt(h, !1)));
    pi = l;
  }
}, 30), Hn = function(t) {
...
Di.prototype = {
  ...
  onSpill: function(t) {
    ...
    var n = Ot(this.sortable.el, this.startIndex, this.options);
...
function ua(s) {
  const t = String(s ?? "area").trim().toLowerCase();
  return t === "floor" ? "floor" : t === "area" ? "area" : t === "building" ? "building" : t === "grounds" ? "grounds" : t === "subarea" ? "subarea" : t === "property" ? "property" : "area";
}
function qn(s) {
  var n;
  ...
  const e = la(s.name);
  if (e) return e;
  const i = ua(t == null ? void 0 : t.type);
  return da(i);
}
function ha(s) {
  return gi(s).reasonLine;
}
function gi(s) {
  var I, L, T;
  if (s.status === "unknown")
  ...
  const t = Ia(s, s.location.id), e = (t == null ? void 0 : t.attributes) || {}, i = (I = s.occupancyTransitions) == null ? void 0 : I[s.location.id], n = s.nowMs ?? Date.now(), o = Ne(
    Oa(i == null ? void 0 : i.changedAt, t == null ? void 0 : t.last_changed, t == null ? void 0 : t.last_updated),
    n
  ), a = s.status === "occupied" ? "Occupied" : "Vacant";
  let r;
  const c = Gn(e, s), l = Vn(e), d = c.length ? [] : ga(l, s), u = c.length ? c : d, h = u.filter((x) => x.kind === "relationship"), _ = u.filter((x) => x.kind !== "relationship"), p = [], f = [];
  s.status === "occupied" ? r = ((L = _[0]) == null ? void 0 : L.lineLabel) || ((T = h[0]) == null ? void 0 : T.lineLabel) || ge(i == null ? void 0 : i.reason, "occupied", s) || ge(e.reason, "occupied", s) || on(l, s) : r = ge(i == null ? void 0 : i.reason, "vacancy", s) || ge(e.reason, "vacancy", s) || on(l, s);
  const m = r ? `${a} · ${r}` : a, y = o ? `${m} (${o})` : m, A = Ea(s, l, u);
  if (s.status === "occupied") {
    const x = [
      ..._.map((D) => D.detailLabel),
      ...A
    ];
    x.length && (p.push(`Held by: ${x.map(Kn).join(", ")}.`), f.push({
      title: "Held by",
      items: x
    }));
  } else if (s.status === "vacant") {
    const x = "No active occupancy sources are currently holding this location.";
    p.push(x), f.push({
      title: "Why vacant",
      note: x
    });
    const D = _a(s, u);
    if (D.length) {
      const W = D.length === 1 ? `${D[0]} is currently on, but it is not holding occupancy. TopoMation will mark occupied again after it turns off and back on, or another source triggers.` : `${D.join(", ")} are currently on, but they are not holding occupancy. TopoMation will mark occupied again after one turns off and back on, or another source triggers.`;
      p.push(`Sensor note: ${W}`), f.push({
        title: "Sensor note",
        note: W
      });
    }
  ...
  b && (p.push(b), f.push({
    title: "Last event",
    note: an(b, "Recent event")
  }));
  const C = Array.isArray(e.locked_by) ? e.locked_by.map((x) => String(x).trim()).filter(Boolean) : [];
  if (e.is_locked || C.length) {
    const x = C.length ? `Lock: held by ${C.map((D) => ze(D)).join(", ")}.` : "Lock: occupancy is currently locked.";
    p.push(x), f.push({
      title: "Lock",
      note: an(x, "Lock")
    });
  }
  if (!p.length && s.status === "occupied") {
    const x = "No source-level evidence is available from the occupancy entity yet.";
    p.push(x), f.push({
      title: "Current evidence",
      note: x
    });
  ...
  return {
    status: s.status,
    statusLabel: a,
    summary: s.status === "occupied" ? ka(r, _, h, w) : Ra(r),
    reasonLine: y,
    details: p,
    detailSections: f
  };
...
function Gn(s, t) {
  ...
  if (!e.length) return [];
  const i = t.nowMs ?? Date.now(), n = kt(t.location), o = [];
  for (const r of e) {
    if (!pa(r, i)) continue;
    const c = String(
      (r == null ? void 0 : r.source_id) || (r == null ? void 0 : r.source) || ""
    ).trim();
    if (!c) continue;
    const l = ma(r, c, n, t), d = l.lineLabel, u = it(r == null ? void 0 : r.updated_at) ?? it(r == null ? void 0 : r.changed_at) ?? it(r == null ? void 0 : r.last_changed) ?? it(r == null ? void 0 : r.timestamp) ?? 0, h = it(r == null ? void 0 : r.expires_at);
    o.push({
      sourceId: c,
      kind: l.kind,
      originLocationId: l.originLocationId,
      lineLabel: d,
      detailLabel: wa(d, u, i, h),
      sentence: l.sentence || Sa(c, d, t),
      ts: u,
      expiresMs: h,
      indefinite: (r == null ? void 0 : r.expires_at) === null || (r == null ? void 0 : r.expires_at) === void 0
    });
  }
  if (!o.length) return [];
  o.sort((r, c) => c.ts - r.ts);
  const a = /* @__PURE__ */ new Map();
  for (const r of o)
    a.has(r.sourceId) || a.set(r.sourceId, r);
  return [...a.values()];
}
function pa(s, t) {
  if (!s) return !1;
  const e = String(s.state || s.value || "").toLowerCase();
  if (e === "off" || e === "inactive" || e === "vacant" || e === "clear")
    return !1;
  if (e === "on" || e === "active" || e === "occupied" || e === "trigger" || s.expires_at === null || s.expires_at === void 0) return !0;
  const i = it(s.expires_at);
  return !!(i && i > t);
}
function Vn(s) {
  const t = s.explanation;
  return t && typeof t == "object" ? t : void 0;
}
function ga(s, t) {
  const e = Array.isArray(s == null ? void 0 : s.held_by) ? s == null ? void 0 : s.held_by : [];
  return e.length ? Gn({ contributions: e }, t) : [];
}
function _a(s, t) {
  var o, a;
  const e = new Set(t.map((r) => r.sourceId)), i = [], n = /* @__PURE__ */ new Set();
  for (const r of kt(s.location)) {
    const c = typeof r.entity_id == "string" ? r.entity_id.trim() : "";
    if (!c || e.has(c)) continue;
    const l = (a = (o = s.hass) == null ? void 0 : o.states) == null ? void 0 : a[c];
    if (!l || !fa(l.state)) continue;
    const d = ne(c, kt(s.location), s);
...
function fa(s) {
  ...
  return ["on", "active", "occupied", "detected", "home", "playing"].includes(t);
}
function ma(s, t, e, i) {
  const n = va(t);
  if (n) {
    ...
    return {
      kind: "relationship",
      originLocationId: n,
      lineLabel: `${d} is occupied through the occupancy group`,
      sentence: `${d} is in the same occupancy group`
    };
  }
  const o = ya(s, t);
  if (!o) {
    const d = ne(t, e, i), u = d === "occupancy group" || zt(t), h = ba(t) || u ? "relationship" : "source";
    return {
      kind: h,
      lineLabel: d,
      sentence: h === "relationship" ? u ? "the occupancy group is occupied" : d : void 0
    };
  }
  const a = (i.locations || []).find((d) => d.id === o.locationId), r = a ? { ...i } : i, c = ne(
    o.sourceId,
    a ? kt(a) : e,
    r
  ), l = nt(o.locationId, i);
  return {
    kind: "source",
    originLocationId: o.locationId,
    lineLabel: `${c} in ${l}`,
    sentence: `${c} in ${l} is active`
  };
}
function ya(s, t) {
  const e = Qt(s == null ? void 0 : s.origin_location_id), i = Qt(s == null ? void 0 : s.origin_source_id);
  return e && i ? { locationId: e, sourceId: i } : Li(t);
}
function Qt(s) {
  return typeof s == "string" ? s.trim() : "";
}
function Li(s) {
  const t = "__group_member__:";
  if (!s.startsWith(t)) return;
  const e = s.slice(t.length), i = e.indexOf("::");
  if (i <= 0) return;
  const n = e.slice(0, i).trim(), o = e.slice(i + 2).trim();
  if (!(!n || !o))
    return { locationId: n, sourceId: o };
}
function va(s) {
  const t = String(s || "").trim();
  return !t.startsWith("linked:") && !t.startsWith("linked.") ? void 0 : t.slice(7).trim() || void 0;
}
function ba(s) {
  const t = String(s || "").trim();
  return t.startsWith("__child__:") || t.startsWith("__child__.") || t.startsWith("__follow_parent__:") || t.startsWith("__follow_parent__.") || t.startsWith("__follow__:") || t.startsWith("__follow__.") || zt(t);
}
function zt(s) {
  const t = String(s || "").trim();
  return /^occupancy[\s_]*group(?:\s*[:.]|\b)/i.test(t);
}
function xa(s) {
  const t = String(s || "").trim().toLowerCase();
  if (!t) return !1;
  const e = t.replace(/^[a-z_]+\./, "");
  return /(?:^|[_\-.])(?:occupancy[_\-.])?group[_\-.][a-z0-9]+/.test(e);
}
function ti(s) {
  return zt(s) ? "occupancy group" : s;
}
function kt(s) {
  var e;
...
function wa(s, t, e, i) {
  const n = [], o = t ? Ne(t, e) : void 0;
  if (o && n.push(`${o} ago`), i && i > e) {
    const a = _i(i, e);
    a && n.push(`holds ${a}`);
  }
...
function Sa(s, t, e) {
  const i = String(s || "").trim(), n = (r) => i.startsWith(r) ? i.slice(r.length).trim() : "", o = n("__child__:") || n("__child__.");
  if (o) return `${nt(o, e)} is occupied`;
  const a = n("__group_member__:") || n("__group_member__.");
  if (a) {
    const r = Li(i), c = (r == null ? void 0 : r.locationId) || a;
    return `${nt(c, e)} is occupied through the group`;
  }
  return zt(i) ? "the occupancy group is occupied" : t.endsWith(" is occupied") ? t : `${t} is active`;
}
function ne(s, t, e) {
  const i = $a(s, e);
  if (i) return i;
  ...
  if (n) return ti(ei(n.entity_id, e.hass));
  if (s.includes("::")) {
    const [o] = s.split("::");
    return ti(ei(o, e.hass));
  }
  return ti(ei(s, e.hass));
}
function $a(s, t) {
  const e = String(s || "").trim();
  if (!e) return;
  if (xa(e)) return "occupancy group";
  const i = (n, o, a) => {
    const r = `${n}${o}`;
  ...
  return Aa(e, t) || (zt(e) ? "occupancy group" : void 0) || i("__child__", ":", (n) => `${n} is occupied`) || i("__child__", ".", (n) => `${n} is occupied`) || i("__follow_parent__", ":", (n) => `linked to ${n}`) || i("__follow_parent__", ".", (n) => `linked to ${n}`) || i("__follow__", ":", (n) => `linked to ${n}`) || i("__follow__", ".", (n) => `linked to ${n}`) || i("__group_member__", ".", (n) => `group member ${n}`) || i("linked", ":", (n) => `${n} is occupied through the occupancy group`) || i("linked", ".", (n) => `${n} is occupied through the occupancy group`) || i("occupancy_group", ":", () => "occupancy group") || i("occupancy_group", ".", () => "occupancy group") || i("__lock_hold__", ":", (n) => `lock hold for ${n}`) || i("__lock_hold__", ".", (n) => `lock hold for ${n}`);
}
function Aa(s, t) {
  const e = Li(s);
  if (e)
    return `group member ${nt(e.locationId, t)}`;
}
function nt(s, t) {
  var o, a;
  const e = String(s || "").trim();
  ...
  return n != null && n.name ? n.name : ze(e);
}
function ze(s) {
...
function ge(s, t, e) {
  ...
  if (n.startsWith("propagation:child:")) {
    ...
    return o ? `child ${nt(o, e)} cleared` : "a child location cleared";
  }
  ...
  return n.startsWith("occupancy:") ? t === "occupied" && n.slice(10) || void 0 : zt(i) ? t === "occupied" ? "the occupancy group is occupied" : void 0 : i;
}
function on(s, t) {
  const e = typeof (s == null ? void 0 : s.basis) == "string" ? s.basis : "";
  if (e) {
    if (e === "occupancy_group") {
      const i = s == null ? void 0 : s.projected_from, o = (Array.isArray(i == null ? void 0 : i.members) ? i.members : []).map((a) => typeof a == "string" ? nt(a, t) : "").filter(Boolean);
      return o.length ? `occupancy group ${o.slice(0, 3).join(", ")} is occupied` : "the occupancy group is occupied";
    }
...
function ka(s, t, e = [], i) {
  const n = Ta(s, t, e);
  return i != null && i.untilLabel ? n ? `Occupied until ${i.untilLabel} because ${n}.` : `Occupied until ${i.untilLabel}.` : n ? `Occupied because ${n}.` : "Occupied. No active holder is exposed by the runtime yet.";
}
function Ta(s, t, e = []) {
  if (t.length) {
    const i = t[0].sentence;
    return t.length === 1 ? i : `${i} and ${t.length - 1} other source${t.length === 2 ? "" : "s"} are active`;
  }
  if (e.length) {
    const i = [...new Set(e.map((o) => o.sentence))], n = i[0];
    return i.length === 1 ? ii(n) : i.includes("the occupancy group is occupied") ? "an occupancy group member is holding this location" : `${ii(n)} and ${i.length - 1} other relationship${i.length === 2 ? "" : "s"} are active`;
  }
  if (s)
    return Kn(ii(s));
}
function ii(s) {
  return s === "the occupancy group is occupied" ? "an occupancy group member is holding this location" : s;
}
function Kn(s) {
  return s.endsWith(".") ? s.slice(0, -1) : s;
}
function Ra(s) {
  return s ? s === "timed out" ? "Vacant because the hold timer expired." : s === "cleared" ? "Vacant because the active source cleared." : s === "vacated" ? "Vacant because it was explicitly vacated." : s.endsWith(".") ? `Vacant because ${s}` : `Vacant because ${s}.` : "Vacant because no occupancy sources are active.";
}
function an(s, t) {
  const e = `${t}:`;
  return s.startsWith(e) ? s.slice(e.length).trim() : s;
}
function Ea(s, t, e) {
  if (s.status !== "occupied") return [];
  const i = nt(s.location.id, s), n = /* @__PURE__ */ new Set();
  for (const o of e)
    o.originLocationId && o.originLocationId !== s.location.id && n.add(o.originLocationId);
  if (!n.size && (t == null ? void 0 : t.basis) === "occupancy_group") {
    const o = t == null ? void 0 : t.projected_from, a = Array.isArray(o == null ? void 0 : o.members) ? o.members : [];
    for (const r of a)
      typeof r == "string" && r && r !== s.location.id && n.add(r);
  }
  return [...n].map((o) => {
    const a = nt(o, s);
    return `${i} is occupied because ${a} is in the same occupancy group.`;
  });
}
function Da(s, t, e) {
  if (e.status !== "occupied") return;
  const i = e.nowMs ?? Date.now(), n = it(s.vacant_at) ?? it(s.effective_timeout_at);
  if (n && n > i) {
    const a = _i(n, i), r = sn(n), c = a ? `, in ${a}` : "";
    return {
      title: "Occupied until",
      untilLabel: r,
      note: `Expected to become vacant at ${r}${c}, unless another source refreshes the hold.`
    };
  }
  const o = t.map((a) => a.expiresMs).filter((a) => typeof a == "number" && a > i).sort((a, r) => r - a)[0];
  if (o) {
    const a = _i(o, i), r = sn(o), c = a ? `, in ${a}` : "";
    return {
      title: "Occupied until",
      untilLabel: r,
      note: `Expected to become vacant at ${r}${c}, after active source holds expire.`
    };
  }
  if (t.some((a) => a.indefinite))
    return {
...
function Ca(s, t) {
  const i = (Array.isArray(s.recent_changes) ? s.recent_changes : [])[0];
  if (!i || typeof i != "object") return rn(s, t);
  const n = String(i.kind || "").toLowerCase(), o = String(i.event || "").toLowerCase(), a = typeof i.source_id == "string" ? i.source_id.trim() : "", r = a ? ne(a, kt(t.location), t) : "", c = it(i.changed_at), l = c ? Ne(c, t.nowMs ?? Date.now()) : void 0, d = l ? ` ${l} ago` : "";
  return n === "signal" && o === "trigger" ? `Recent event: ${r || "A source"} reported activity${d}.` : n === "signal" && o === "clear" ? `Recent event: ${r || "A source"} cleared${d}.` : n === "state" && o === "occupied" ? Ee(i, !0) ? `Recent event: Occupancy refreshed${d}.` : `Recent event: Became occupied${d}.` : n === "state" && o === "vacant" ? Ee(i, !1) ? `Recent event: Still vacant${d}.` : `Recent event: Became vacant${d}.` : o ? `Recent event: ${ze(o)}${d}.` : rn(s, t);
}
function rn(s, t) {
  var c;
  const e = (c = Vn(s)) == null ? void 0 : c.latest_transition;
  if (!e || typeof e != "object") return;
  const i = String(e.event || "").toLowerCase();
  if (!i) return;
  const n = it(e.changed_at), o = n ? Ne(n, t.nowMs ?? Date.now()) : void 0, a = o ? ` ${o} ago` : "", r = La(e, t);
  return i === "occupied" ? !r && Ee(e, !0) ? `Recent event: Occupancy refreshed${a}.` : r ? `Recent event: ${r} reported activity${a}.` : `Recent event: Became occupied${a}.` : i === "vacant" ? !r && Ee(e, !1) ? `Recent event: Still vacant${a}.` : r ? `Recent event: ${r} cleared${a}.` : `Recent event: Became vacant${a}.` : `Recent event: ${ze(i)}${a}.`;
}
function Ee(s, t) {
  return (typeof s.previous_occupied == "boolean" ? s.previous_occupied : typeof s.previousOccupied == "boolean" ? s.previousOccupied : void 0) === t;
}
function La(s, t) {
  const e = Qt(s.origin_source_id) || Qt(s.source_id);
  if (!e) return;
  const i = Qt(s.origin_location_id), n = i ? (t.locations || []).find((r) => r.id === i) : void 0, o = n ? { ...t } : t, a = ne(
    e,
    kt(n || t.location),
    o
  );
  return i ? `${a} in ${nt(i, t)}` : a;
}
function it(s) {
...
function Ia(s, t) {
  var o, a, r;
  const e = (o = s.occupancyRuntimeStates) == null ? void 0 : o[t];
  if (e) return e;
  const i = (a = s.occupancyStates) == null ? void 0 : a[t];
  if (typeof i != "boolean") return;
  const n = (r = s.occupancyTransitions) == null ? void 0 : r[t];
  return {
    entity_id: `binary_sensor.topomation_occupancy_projection_${t}`,
    state: i ? "on" : "off",
    last_changed: n == null ? void 0 : n.changedAt,
    last_updated: n == null ? void 0 : n.changedAt,
    attributes: {
      device_class: "occupancy",
      location_id: t,
      previous_occupied: n == null ? void 0 : n.previousOccupied,
...
function _i(s, t) {
  const e = Math.max(0, Math.floor((s - t) / 1e3));
  if (e <= 0) return;
  const i = Math.floor(e / 86400), n = Math.floor(e % 86400 / 3600), o = Math.floor(e % 3600 / 60), a = e % 60, r = [];
  return i > 0 && r.push(`${i}d`), n > 0 && r.push(`${n}h`), o > 0 && r.length < 2 && r.push(`${o}m`), r.length || r.push(`${a}s`), r.slice(0, 2).join(" ");
}
...
function cn(s, t) {
  const e = new Map(s.map((u) => [u.id, u])), i = /* @__PURE__ */ new Map(), n = (u) => {
    const h = u.parent_id;
    return !h || h === u.id || !e.has(h) ? null : h;
  };
  for (const u of s) {
    const h = n(u);
    i.has(h) || i.set(h, []), i.get(h).push(u);
  }
  ...
  for (const u of s) {
    ...
    a.add(u.id);
    const _ = (i.get(u.id) || []).length > 0, p = t.has(u.id);
    o.push({ location: u, depth: 0, hasChildren: _, isExpanded: p }), p && _ && d(u.id, 1);
  }
  return o;
}
function ln(s, t, e, i) {
...
function Fa(s, t, e, i, n) {
  const o = Na(s, t), a = s.filter((u) => !o.has(u.location.id)), r = a.find((u) => u.location.id === i);
  if (!r) return { parentId: e, siblingIndex: 0 };
  const c = n === "inside" ? i : r.location.parent_id, l = a.filter((u) => u.location.parent_id === c), d = l.findIndex((u) => u.location.id === i);
...
const dn = "application/x-topomation-entity-id", De = class De extends ft {
  constructor() {
    super(...arguments), this.locations = [], this.version = 0, this.occupancyStates = {}, this.occupancyTransitions = {}, this.occupancyRuntimeStates = {}, this.readOnly = !1, this.allowMove = !1, this.allowRename = !1, this._expandedIds = /* @__PURE__ */ new Set(), this._editingValue = "", this._isDragging = !1, this._hasInitializedExpansion = !1;
  }
  _resolveRelatedId(t) {
    var a;
      ...
      e && (this._sortable = $.create(e, {
        ...
        onMove: (n) => {
          ...
          if (o && (a != null && a.classList.contains("tree-item"))) {
            ...
            const l = a.getBoundingClientRect(), d = n.originalEvent, u = typeof (d == null ? void 0 : d.clientX) == "number" ? d.clientX : l.left + l.width / 2, h = typeof (d == null ? void 0 : d.clientY) == "number" ? d.clientY : l.top + l.height / 2, _ = this.locations.find((y) => y.id === o), p = (_ == null ? void 0 : _.parent_id) ?? null, m = ln(l, u, h, c === p);
  ...
  _handleDragEnd(t) {
    ...
    const a = cn(this.locations, this._expandedIds), r = Fa(
      a,
      i,
      n.parent_id,
      o.relatedId,
      o.zone
    ), { parentId: c, siblingIndex: l } = r, d = a.filter((u) => u.location.parent_id === n.parent_id).findIndex((u) => u.location.id === i);
    if (c === n.parent_id && l === d) {
      this._restoreTreeAfterCancelledDrop();
      return;
    }
    if (!ko({ locations: this.locations, locationId: i, newParentId: c })) {
      this._restoreTreeAfterCancelledDrop();
      return;
    }
  ...
  _handleContinuousDragOver(t) {
    ...
    if (!n || n === e) return;
    const o = i.getBoundingClientRect(), a = this.locations.find((h) => h.id === e), r = (a == null ? void 0 : a.parent_id) ?? null, c = n === r, l = ln(o, t.clientX, t.clientY, c);
  ...
  _updateDropIndicator(t, e, i) {
    ...
    this._dropIndicator = { top: u, left: l, width: d, intent: r, label: c };
  }
  ...
  render() {
    if (!this.locations.length)
      ...
      `;
    const t = cn(this._visibleTreeLocations(), this._expandedIds), e = this._computeOccupancyStatusByLocation(), i = this._computeLockStateByLocation();
    return g`
      <div class="tree-list">
        ${me(
      t,
  ...
  _renderItem(t, e, i) {
    const { location: n, depth: o, hasChildren: a, isExpanded: r } = t, c = this.selectedId === n.id, l = this._editingId === n.id, d = o * 24, u = z(n), h = n.is_explicit_root ? "root" : u, _ = n.is_explicit_root ? "home root" : u, p = i.isLocked ? "mdi:lock" : "mdi:lock-open-variant-outline", f = i.isLocked ? i.lockedBy.length ? `Locked (${i.lockedBy.map((b) => Ti(b)).join(", ")})` : "Locked" : "Unlocked", m = this._isEffectivelyOccupied(n), y = "mdi:home-switch-outline", A = m ? "Set vacant" : "Set occupied", w = ha({
      location: n,
    ...
    return g`
      ...
      this.readOnly || n.is_explicit_root || b.key !== "Enter" && b.key !== " " || (b.preventDefault(), b.stopPropagation(), this._handleOccupancyToggle(b, n, m));
        ...
        <span class="type-badge ${h}">${_}</span>
  ...
  _computeOccupancyStatusByLocation() {
    ...
    for (const i of this.locations || []) {
      const n = (e = this.occupancyStates) == null ? void 0 : e[i.id];
      t[i.id] = n === !0 ? "occupied" : n === !1 ? "vacant" : "unknown";
    }
    return t;
  }
  _computeLockStateByLocation() {
    const t = {};
    for (const [e, i] of Object.entries(this.occupancyRuntimeStates || {})) {
      const n = (i == null ? void 0 : i.attributes) || {};
      if (!e) continue;
      const o = n.locked_by;
      t[e] = {
        isLocked: !!n.is_locked,
        lockedBy: Array.isArray(o) ? o.map((a) => String(a)) : []
      };
    }
    return t;
  }
  _lockStateForLocation(t, e) {
    return e[t.id] || { isLocked: !1, lockedBy: [] };
  }
  _isEffectivelyOccupied(t) {
    var e;
    return ((e = this.occupancyStates) == null ? void 0 : e[t.id]) === !0;
  }
  ...
  _getIcon(t) {
    var e, i, n;
    return t.ha_area_id && ((n = (i = (e = this.hass) == null ? void 0 : e.areas) == null ? void 0 : i[t.ha_area_id]) != null && n.icon) ? this.hass.areas[t.ha_area_id].icon : qn(t);
  }
  _hasEntityDragPayload(t) {
    var i;
    const e = Array.from(((i = t.dataTransfer) == null ? void 0 : i.types) || []);
    return e.includes(dn) ? !0 : !this._isDragging && e.includes("text/plain");
  }
  _readEntityIdFromDrop(t) {
    var n, o;
    const e = (n = t.dataTransfer) == null ? void 0 : n.getData(dn);
    if (e) return e;
...
De.properties = {
  ...
  occupancyRuntimeStates: { attribute: !1 },
...
let fi = De;
customElements.get("ht-location-tree") || customElements.define("ht-location-tree", fi);
function Ba(s) {
...
function ni(s, t, e) {
  const i = Yn(e == null ? void 0 : e.entity_id), n = Qn(e);
  if (Xn(i)) {
    const a = s.on_timeout && s.on_timeout > 0 ? s.on_timeout : pt;
    return {
      ...s,
      mode: "any_change",
      on_event: "trigger",
  ...
  if (t === "any_change") {
    const a = s.on_timeout ?? (n.mode === "any_change" ? n.on_timeout : pt);
    return {
      ...s,
      mode: t,
      on_event: "trigger",
...
function Jn(s) {
  if (!Array.isArray(s) || s.length === 0)
    return !1;
  const t = s[0], e = String((t == null ? void 0 : t.entity_id) || "").trim(), i = String((t == null ? void 0 : t.service) || "").trim();
  return e.startsWith("vacuum.") && i === "start";
}
function mi(s, t) {
  return !!s && Jn(t);
}
function Ha(s) {
  const t = String(s.entity_id || "").trim();
  if (t.startsWith("automation."))
    return t;
  const e = String(s.id || "").trim();
  return e.startsWith("automation.") ? e : e && !e.startsWith("action_rule_") ? `automation.${e}` : "";
}
function qa(s, t) {
  var c, l;
  if (!t.startsWith("automation."))
    return "Save the rule to track daily run status.";
  const e = (c = s == null ? void 0 : s.states) == null ? void 0 : c[t], i = (l = e == null ? void 0 : e.attributes) == null ? void 0 : l.last_triggered;
  if (!i)
  ...
  return n.getFullYear() === o.getFullYear() && n.getMonth() === o.getMonth() && n.getDate() === o.getDate() ? `Already ran today at ${n.toLocaleTimeString([], { hour: "numeric", minute: "2-digit" })}` : "Eligible to run today";
}
const Ga = [
  "on_occupied",
  "on_vacant",
...
const Va = "topomation/actions/rules/list", Ka = "topomation/actions/rules/create", Ya = "topomation/actions/rules/delete";
function Xa(s) {
...
function Oi(s) {
  const t = String(s || "").trim().toLowerCase();
  return t === "on_occupied" || t === "on_vacant" || t === "on_dark" || t === "on_bright" ? t : null;
}
function yi(s, t) {
  const e = /* @__PURE__ */ new Set();
  if (Array.isArray(s))
  ...
  return e.size === 0 && t && e.add(t), Ga.filter((i) => e.has(i));
}
function vi(s) {
...
function to(s, t) {
  ...
  return e === "any" || e === "dark" || e === "bright" ? e : Qa(s);
}
function hn(s) {
...
function Za(s, t) {
  const e = String(s || "").split(".", 1)[0], i = t === "on_vacant" || t === "on_bright";
  return e === "media_player" ? i ? "media_stop" : "media_play" : e === "switch" || e === "light" ? i ? "turn_off" : "turn_on" : e === "vacuum" ? t === "on_occupied" ? "pause" : "start" : i ? "turn_off" : "turn_on";
}
function bi(s, t) {
  const i = (Array.isArray(s.actions) ? s.actions : []).map((n) => {
    if (!n || typeof n != "object") return;
    const o = String(n.entity_id || "").trim();
    if (!o) return;
    const r = String(n.service || "").trim() || Za(o, t), c = Ja(o, r) && typeof n.only_if_off == "boolean" ? !!n.only_if_off : void 0;
    return {
      entity_id: o,
      service: r,
      ...hn(n.data) ? { data: hn(n.data) } : {},
      ...typeof c == "boolean" ? { only_if_off: c } : {}
    };
  }).filter((n) => !!n);
  return i.length > 0 ? i : [];
}
  ...
  try {
    ...
    if (Array.isArray(i == null ? void 0 : i.rules))
      return i.rules.map((n) => {
        const o = Oi(n.trigger_type), a = yi(n.trigger_types, o || void 0);
        ...
        return {
          ...
          actions: l,
          ambient_condition: c,
          must_be_occupied: Zn(n.must_be_occupied),
          require_property_activity: !!n.require_property_activity,
          ...
          user_named: typeof n.user_named == "boolean" ? n.user_named : void 0,
          daily_gating_enabled: typeof n.daily_gating_enabled == "boolean" ? n.daily_gating_enabled : void 0
        };
      }).filter((n) => !!n).sort((n, o) => n.name.localeCompare(o.name));
  } catch (i) {
    throw Ii(i) ? Pt("rule listing") : i;
  }
  throw Pt("rule listing");
}
async function pn(s, t, e) {
  const i = yi(t.trigger_types, t.trigger_type), n = vi(i), o = bi(
    { actions: t.actions },
    n
  );
  if (!o[0])
    throw new Error("At least one action target is required");
  const r = typeof t.run_on_startup == "boolean" ? t.run_on_startup : void 0, c = mi(
    t.daily_gating_enabled,
    o
  );
  try {
    const l = await s.callWS({
      type: Ka,
      ...
      ...t.require_property_activity ? { require_property_activity: !0 } : {},
    ...
    if (l != null && l.rule) {
      const d = yi(
        l.rule.trigger_types,
        Oi(l.rule.trigger_type) || n
      ), u = vi(d), h = to(
        d,
        l.rule.ambient_condition
      ), _ = bi(l.rule, u);
      return {
        ...l.rule,
        trigger_type: u,
        trigger_types: d,
        rule_uuid: typeof l.rule.rule_uuid == "string" && l.rule.rule_uuid.trim().length > 0 ? l.rule.rule_uuid.trim() : t.rule_uuid,
        actions: _,
        ambient_condition: h,
        must_be_occupied: Zn(l.rule.must_be_occupied),
        require_property_activity: !!l.rule.require_property_activity,
        time_condition_enabled: !!l.rule.time_condition_enabled,
        start_time: typeof l.rule.start_time == "string" && l.rule.start_time.length > 0 ? l.rule.start_time : void 0,
        end_time: typeof l.rule.end_time == "string" && l.rule.end_time.length > 0 ? l.rule.end_time : void 0,
        run_on_startup: typeof l.rule.run_on_startup == "boolean" ? l.rule.run_on_startup : r,
        daily_gating_enabled: typeof l.rule.daily_gating_enabled == "boolean" ? l.rule.daily_gating_enabled : c
      };
    }
  } catch (l) {
    throw Ii(l) ? Pt("rule creation") : l;
  }
  throw Pt("rule creation");
}
async function gn(s, t, e) {
  ...
  try {
    ...
    throw Ii(o) ? Pt("rule deletion") : o;
  }
  throw Pt("rule deletion");
}
var vn, bn;
try {
  (bn = (vn = import.meta) == null ? void 0 : vn.hot) == null || bn.accept(() => window.location.reload());
} catch {
}
const Ce = class Ce extends ft {
  constructor() {
    super(...arguments), this.allLocations = [], this.adjacencyEdges = [], this.entityRegistryRevision = 0, this.occupancyStates = {}, this.occupancyTransitions = {}, this.occupancyRuntimeStates = {}, this.handoffTraces = [], this._activeTab = "detection", this._occupancyDraftDirty = !1, this._savingOccupancyDraft = !1, this._pendingOccupancyByLocation = {}, this._externalSourceDialogOpen = !1, this._externalAreaId = "", this._externalEntityId = "", this._entityAreaById = {}, this._entityRegistryMetaById = {}, this._liveSourceEntityStates = {}, this._actionRules = [], this._actionRulesDraftDirty = !1, this._savingActionRules = !1, this._loadingActionRules = !1, this._nowEpochMs = Date.now(), this._editingActionRuleNameValue = "", this._editingActionRuleNameFallback = "", this._actionRuleTabById = {}, this._climateDeviceLinkRevision = 0, this._climateHostDeviceIds = /* @__PURE__ */ new Set(), this._deviceViaParentId = /* @__PURE__ */ new Map(), this._entityRegistryDeviceByEntityId = /* @__PURE__ */ new Map(), this._syncImportInProgress = !1, this._managedShadowAutoRepairInProgress = !1, this._adjacencyNeighborId = "", this._adjacencyBoundaryType = "door", this._adjacencyDirection = "bidirectional", this._adjacencyCrossingSources = "", this._adjacencyHandoffWindowSec = 12, this._adjacencyPriority = 50, this._savingAdjacency = !1, this._wiabInteriorEntityId = "", this._wiabDoorEntityId = "", this._wiabExteriorDoorEntityId = "", this._wiabShowAllEntities = !1, this._ambientDraftDirty = !1, this._loadingAmbientReading = !1, this._savingAmbientConfig = !1, this._recentActivityDraftDirty = !1, this._savingRecentActivityConfig = !1, this._floorGroupCreateSelection = [], this._onTimeoutMemory = {}, this._actionRulesLoadSeq = 0, this._ambientReadingLoadSeq = 0, this._sourceStateWatchEntityIds = /* @__PURE__ */ new Set(), this._sourceStateWatchKey = "", this._beforeUnloadHandler = (t) => {
  ...
  willUpdate(t) {
    ...
    if (t.has("hass")) {
      ...
      o !== a && (this._entityAreaById = {}, this._entityAreaLoadPromise = void 0, this.hass ? (this._loadEntityAreaAssignments(), this._loadClimateDeviceLinkIndex(), this._loadActionRules(), this._subscribeAutomationStateChanged()) : (this._unsubAutomationStateChanged && (this._unsubAutomationStateChanged(), this._unsubAutomationStateChanged = void 0), this._automationStateSubscriptionConnection = void 0, this._teardownSourceStateSubscription()));
    }
    if (t.has("forcedTab")) {
    ...
    if (t.has("location")) {
      ...
      if (o !== a) {
        ...
        this._occupancyDraftDirty || this._resetDetectionDraftFromLocation(), this._ambientDraftDirty || this._resetAmbientDraftFromLocation(), this._recentActivityDraftDirty || this._resetRecentActivityDraftFromLocation();
    ...
    this._showsManagedShadowControls() && (t.has("allLocations") || t.has("location")) && this._maybeAutoRepairManagedShadowArea(), t.has("entityRegistryRevision") && (this._loadEntityAreaAssignments(), this._loadClimateDeviceLinkIndex()), (t.has("hass") || t.has("location") || t.has("forcedTab") || t.has("_activeTab") || t.has("_occupancyDraft") || t.has("_externalSourceDialogOpen") || t.has("_externalAreaId") || t.has("_externalEntityId") || t.has("_entityAreaById") || t.has("_entityRegistryMetaById")) && this._refreshSourceStateWatchSet();
  }
  updated(t) {
  ...
  async _loadActionRules() {
    ...
    try {
      const n = await _e(this.hass, e, this.entryId);
  ...
  _sanitizeOccupancyConfig(t) {
    const e = this._occupancyDefaults(), n = (Array.isArray(t.occupancy_sources) ? t.occupancy_sources : []).filter((c) => c && typeof c.entity_id == "string" && c.entity_id.trim().length > 0).map((c) => this._normalizeSource(c.entity_id.trim(), c)), o = Math.max(1, Number(t.default_timeout) || e.default_timeout), a = Math.max(
      0,
      Number(t.default_trailing_timeout) || e.default_trailing_timeout || 0
    ), r = {
      version: typeof t.version == "number" && Number.isFinite(t.version) ? t.version : e.version,
      enabled: t.enabled !== !1,
      default_timeout: o,
      default_trailing_timeout: a,
      wiab: t.wiab,
      occupancy_group_id: typeof t.occupancy_group_id == "string" && t.occupancy_group_id.trim().length > 0 ? t.occupancy_group_id.trim() : null,
      occupancy_sources: n
    };
    return r.wiab = this._getWiabConfig(r), r;
  }
  _persistedOccupancyConfig() {
    var e, i;
    const t = ((i = (e = this.location) == null ? void 0 : e.modules) == null ? void 0 : i.occupancy) || {};
    return this._sanitizeOccupancyConfig(t);
  }
  _persistedOccupancyConfigForLocation(t) {
    var i;
    const e = ((i = t.modules) == null ? void 0 : i.occupancy) || {};
    return this._sanitizeOccupancyConfig(e);
  }
  _detectionTabLabel() {
    return this._isOccupancyGroupHostLocation() ? "Occupancy Groups" : "Occupancy";
  }
  _locationType() {
    return this.location ? z(this.location) : null;
  }
  _isAreaLikeLocation() {
  ...
  _isOccupancyGroupHostLocation(t = this.location) {
    return !!t && this._isOccupancyGroupHostType(z(t));
  }
  ...
  _structuralInspectorTabSet() {
    return this._locationType() === "property" ? /* @__PURE__ */ new Set(["detection", "recent_activity", "ambient"]) : /* @__PURE__ */ new Set([
      "detection",
      "ambient",
      "lighting",
      "appliances",
  ...
  _setOccupancyDraft(t) {
    this._occupancyDraft = this._sanitizeOccupancyConfig(t), this._occupancyDraftDirty = !0, this._occupancySaveError = void 0, this._detectionDraftHint = "Changes are staged locally. Click Save changes to apply them.", this.requestUpdate();
  }
  _occupancyConfigForLocation(t) {
    ...
    return this._sanitizeOccupancyConfig(i);
  }
  _setPendingOccupancyForLocation(t, e) {
    const i = this._sanitizeOccupancyConfig(e);
  ...
  async _saveDetectionDraft() {
    ...
    const t = this.location.id, e = this._sanitizeOccupancyConfig(this._occupancyDraft || this._persistedOccupancyConfig()), i = [
      { locationId: t, config: e },
      ...Object.entries(this._pendingOccupancyByLocation).filter(([o]) => o !== t).map(([o, a]) => ({
        locationId: o,
        config: this._sanitizeOccupancyConfig(a)
      }))
    ];
  ...
  _sanitizeAmbientConfig(t) {
    ...
    ), a = this._normalizeAmbientLocalLuxLightEntityIds(t);
    return {
      ...e,
      ...t,
      lux_sensor: i,
      ...
      bright_threshold: o,
      fallback_to_sun: !0,
      local_lux_light_entity_ids: a
    };
  }
  _normalizeAmbientLocalLuxLightEntityIds(t) {
    return Array.isArray(t.local_lux_light_entity_ids) ? [...new Set(t.local_lux_light_entity_ids)].filter((e) => typeof e == "string" && e.startsWith("light.")).sort((e, i) => this._entityName(e).localeCompare(this._entityName(i))) : [];
  }
  ...
  _ambientConfigSignature(t) {
    ...
    return JSON.stringify({
      ...
      local_lux_light_entity_ids: e.local_lux_light_entity_ids || []
    });
  }
  _getAmbientConfig() {
  ...
  _recentActivityDefaults() {
    return {
      version: 1,
      enabled: !1,
      window_hours: 48,
      include_descendant_occupancy: !0
    };
  }
  _sanitizeRecentActivityConfig(t) {
    const e = this._recentActivityDefaults(), i = Number(t.window_hours), n = Number.isFinite(i) ? Math.max(1, Math.min(24 * 30, i)) : e.window_hours;
    return {
      ...e,
      ...t,
      version: 1,
      enabled: !!t.enabled,
      window_hours: n,
      include_descendant_occupancy: typeof t.include_descendant_occupancy == "boolean" ? t.include_descendant_occupancy : e.include_descendant_occupancy
    };
  }
  _persistedRecentActivityConfig() {
    var e, i;
    const t = ((i = (e = this.location) == null ? void 0 : e.modules) == null ? void 0 : i.recent_activity) || {};
    return this._sanitizeRecentActivityConfig(t);
  }
  _resetRecentActivityDraftFromLocation() {
    this._recentActivityDraft = this._persistedRecentActivityConfig(), this._recentActivityDraftDirty = !1, this._recentActivitySaveError = void 0;
  }
  _recentActivityConfigSignature(t) {
    const e = this._sanitizeRecentActivityConfig(t);
    return JSON.stringify({
      enabled: !!e.enabled,
      window_hours: Number(e.window_hours || 48),
      include_descendant_occupancy: !!e.include_descendant_occupancy
    });
  }
  _getRecentActivityConfig() {
    return this._sanitizeRecentActivityConfig(
      this._recentActivityDraft || this._persistedRecentActivityConfig()
    );
  }
  _setRecentActivityDraft(t) {
    const e = this._sanitizeRecentActivityConfig(t);
    this._recentActivityDraft = e, this._recentActivityDraftDirty = this._recentActivityConfigSignature(e) !== this._recentActivityConfigSignature(this._persistedRecentActivityConfig()), this._recentActivitySaveError = void 0, this.requestUpdate();
  }
  async _saveRecentActivityDraft() {
    if (!this.location || !this.hass) return;
    this._savingRecentActivityConfig = !0, this._recentActivitySaveError = void 0;
    const t = this._sanitizeRecentActivityConfig(
      this._recentActivityDraft || this._persistedRecentActivityConfig()
    );
    try {
      await this.hass.callWS(
      ...
      ), this.location.modules = this.location.modules || {}, this.location.modules.recent_activity = t, this._recentActivityDraft = t, this._recentActivityDraftDirty = !1, this._showToast("Recent activity settings updated", "success");
    } catch (e) {
      console.error("Failed to update recent activity settings", e), this._recentActivitySaveError = (e == null ? void 0 : e.message) || "Failed to update recent activity settings", this._showToast(this._recentActivitySaveError, "error");
    } finally {
      this._savingRecentActivityConfig = !1, this.requestUpdate();
    }
  }
  _discardRecentActivityDraft(t = !0) {
    this._resetRecentActivityDraftFromLocation(), this.requestUpdate(), t && this._showToast("Discarded recent activity changes", "success");
  }
  ...
  _renderHeader() {
    if (!this.location) return "";
    const t = this.location.ha_area_id, e = t ? "HA Area ID" : "Location ID", i = t || this.location.id, n = this._getLockState(), o = this._getOccupancyState(), a = this._treeAlignedOccupiedState(o), r = a === !0, c = a === !0 ? "Occupied" : a === !1 ? "Vacant" : "Unknown", l = gi({
      ...
      status: a === !0 ? "occupied" : a === !1 ? "vacant" : "unknown",
      nowMs: this._nowEpochMs
    }), d = o ? this._resolveVacantAt(o.attributes || {}, r) : void 0, u = d instanceof Date, h = r ? this._formatVacantAtLabel(d, this._isStructuralSummaryLocation()) : void 0, p = this._ambientSourceMethod(this._ambientReading) === "inherited_sensor" ? " (inherited)" : "", f = this._loadingAmbientReading ? "Ambient: loading..." : this._ambientReadingError ? "Ambient: unavailable" : `Ambient: ${this._formatAmbientLux(this._ambientReading)}${p}`;
    return g`
      <div class="header">
        <div class="header-main">
          ...
          <div class="header-content">
            ...
            <div class="header-status">
              ...
              ${this._renderHeaderOccupancyReason(l)}
              ${n.isLocked ? g`
  ...
  _renderHeaderOccupancyReason(t) {
    var o;
    if (!t.summary) return "";
    const e = t.details || [], i = (o = t.detailSections) != null && o.length ? t.detailSections : e.map((a, r) => ({
      title: r === 0 ? "Current evidence" : "Context",
      note: a
    })), n = t.statusLabel ? `${t.statusLabel} status` : "Occupancy status";
    return g`
      <details class="header-occupancy-reason" data-testid="header-occupancy-reason">
        <summary
          aria-label=${i.length ? "Show occupancy explanation" : "Occupancy explanation"}
        >
        ...
        ${i.length ? g`
              <div class="header-reason-panel" role="note">
                <div class="header-reason-title">${n}</div>
                ${i.map(
      (a) => {
        var r;
        return g`
                    <section class="header-reason-section">
                      <div class="header-reason-section-title">${a.title}</div>
                      ${(r = a.items) != null && r.length ? g`
                            <ul class="header-reason-list">
                              ${a.items.map(
          (c) => g`<li class="header-reason-item">${c}</li>`
        )}
                            </ul>
                          ` : ""}
                      ${a.note ? g`<div class="header-reason-note">${a.note}</div>` : ""}
                    </section>
                  `;
      }
    )}
  ...
  _headerIcon(t) {
    ...
    return e && ((o = (n = (i = this.hass) == null ? void 0 : i.areas) == null ? void 0 : n[e]) != null && o.icon) ? this.hass.areas[e].icon : qn(t);
  }
  /** Structural hosts: rollup occupancy, ambient, and aggregate device automation (ADR-HA-078). */
  _renderStructuralTabs() {
    const t = this._detectionTabLabel(), e = this._locationType() === "property";
    return g`
      <div class="tabs">
        <button
  ...
  _hasUnsavedDrafts() {
    return !!(this._occupancyDraftDirty || this._ambientDraftDirty || this._recentActivityDraftDirty || this._actionRulesDraftDirty);
  }
  _handleTabChange(t) {
    if (this._activeTab !== t) {
      ...
      if (this._activeTab === "recent_activity" && this._recentActivityDraftDirty) {
        ...
        this._discardRecentActivityDraft(!1);
      }
  ...
  _mapRequestedTab(t) {
    ...
    if (t === "recent_activity") return "recent_activity";
  ...
  connectedCallback() {
    super.connectedCallback(), window.addEventListener("beforeunload", this._beforeUnloadHandler), this._startClockTicker(), this._subscribeAutomationStateChanged(), this.updateComplete.then(() => {
      this.isConnected && this._refreshSourceStateWatchSet();
    });
  }
  disconnectedCallback() {
    ...
    if (!(this._unsubAutomationStateChanged && this._automationStateSubscriptionConnection === t)) {
      ...
      try {
        this._unsubAutomationStateChanged = await t.subscribeEvents(
          (i) => {
            var l, d, u;
            const n = (l = i == null ? void 0 : i.data) == null ? void 0 : l.entity_id, o = (d = i == null ? void 0 : i.data) == null ? void 0 : d.new_state, a = (u = i == null ? void 0 : i.data) == null ? void 0 : u.old_state, r = (o == null ? void 0 : o.attributes) || {}, c = (a == null ? void 0 : a.attributes) || {};
  ...
  async _subscribeSourceStateChanged() {
    var e, i;
    const t = (e = this.hass) == null ? void 0 : e.connection;
    ...
    if (!(this._unsubSourceStateChanged && this._sourceStateSubscriptionConnection === t)) {
      this._unsubscribeSourceStateChanged();
      try {
        const n = await t.subscribeEvents(
          (o) => this._handleWatchedSourceStateChanged(o),
          "state_changed"
        );
        if (!this._sourceStateWatchEntityIds.size || ((i = this.hass) == null ? void 0 : i.connection) !== t) {
          typeof n == "function" && n();
          return;
        }
        this._unsubSourceStateChanged = n, this._sourceStateSubscriptionConnection = t;
      } catch {
        this._sourceStateSubscriptionConnection = void 0;
      }
    }
  }
  _unsubscribeSourceStateChanged() {
    this._unsubSourceStateChanged && (this._unsubSourceStateChanged(), this._unsubSourceStateChanged = void 0), this._sourceStateSubscriptionConnection = void 0;
  }
  _teardownSourceStateSubscription() {
    this._unsubscribeSourceStateChanged(), this._sourceStateWatchEntityIds = /* @__PURE__ */ new Set(), this._sourceStateWatchKey = "", Object.keys(this._liveSourceEntityStates).length && (this._liveSourceEntityStates = {});
  }
  _handleWatchedSourceStateChanged(t) {
    var o, a;
    const e = typeof ((o = t == null ? void 0 : t.data) == null ? void 0 : o.entity_id) == "string" ? t.data.entity_id : "";
    if (!e || !this._sourceStateWatchEntityIds.has(e)) return;
    const i = (a = t == null ? void 0 : t.data) == null ? void 0 : a.new_state, n = { ...this._liveSourceEntityStates };
    i && typeof i == "object" ? n[e] = i : n[e] = {
      entity_id: e,
      state: "unavailable",
      attributes: {},
      last_changed: t == null ? void 0 : t.time_fired,
      last_updated: t == null ? void 0 : t.time_fired
    }, this._liveSourceEntityStates = n;
  }
  _refreshSourceStateWatchSet() {
    const t = this._sourceStateWatchEntityIdsForCurrentView(), e = [...t].sort().join("|");
    if (e === this._sourceStateWatchKey) return;
    this._sourceStateWatchEntityIds = t, this._sourceStateWatchKey = e;
    const i = {};
    for (const n of t) {
      const o = this._liveSourceEntityStates[n];
      o && (i[n] = o);
    }
    Object.keys(i).length !== Object.keys(this._liveSourceEntityStates).length && (this._liveSourceEntityStates = i), t.size ? this._subscribeSourceStateChanged() : this._unsubscribeSourceStateChanged();
  }
  _sourceStateWatchEntityIdsForCurrentView() {
    var n;
    const t = /* @__PURE__ */ new Set(), e = (o) => {
      typeof o != "string" || !o.trim() || t.add(o.trim());
    }, i = this._getOccupancyConfig();
    for (const o of this._workingSources(i))
      e(o.entity_id);
    if (this._activeTab === "detection" && this.location) {
      const o = new Set(this.location.entity_ids || []);
      if (this.location.ha_area_id)
        for (const a of this._entitiesForArea(this.location.ha_area_id))
          o.add(a);
      for (const a of o)
        this._isCoreAreaSourceEntity(a) && e(a);
    }
    if (this._externalSourceDialogOpen) {
      e(this._externalEntityId);
      const o = this._externalAreaId || "", a = ((n = this.location) == null ? void 0 : n.ha_area_id) || "", r = o ? o === "__this_area__" ? a ? this._entitiesForArea(a) : [] : this._entitiesForArea(o) : [];
      for (const c of r)
        e(c);
    }
    return t;
  ...
  _recentActivityEntityState() {
    var t;
    if (!(!this.location || !((t = this.hass) != null && t.states)))
      return Object.values(this.hass.states).find((e) => {
        var n;
        const i = (e == null ? void 0 : e.attributes) || {};
        return String((e == null ? void 0 : e.entity_id) || "").startsWith("binary_sensor.") && i.location_id === ((n = this.location) == null ? void 0 : n.id) && Object.prototype.hasOwnProperty.call(i, "recently_active");
      });
  }
  _ancestorPropertyWithRecentActivity() {
    var e;
    if (!this.location) return;
    let t = this.location;
    for (; t; ) {
      if (z(t) === "property" && this._sanitizeRecentActivityConfig(
        ((e = t.modules) == null ? void 0 : e.recent_activity) || {}
      ).enabled)
        return t;
      t = this._locationById(t.parent_id ?? null);
    }
  }
  _canRequirePropertyActivity() {
    return !!this._ancestorPropertyWithRecentActivity();
  }
  _renderRecentActivitySection() {
    if (!this.location || this._locationType() !== "property") return "";
    const t = this._getRecentActivityConfig(), e = this._recentActivityEntityState(), i = (e == null ? void 0 : e.attributes) || {}, n = (e == null ? void 0 : e.state) === "on" || i.recently_active === !0, o = this._parseDateValue(String(i.last_activity_at || "")), a = this._parseDateValue(String(i.active_until || "")), r = this._savingRecentActivityConfig;
    return g`
      <div class="card-section" data-testid="recent-activity-section">
        ...
        <div class="occupancy-at-a-glance" style="margin-top: 12px;">
          <div class="occupancy-status-chip ${n ? "is-occupied" : "is-vacant"}">
            ${n ? "Active" : "Inactive"}
          </div>
          <div class="occupancy-primary-detail">
            ${n && a ? `Active until ${this._formatDateTime(a)}` : o ? `Last activity ${this._formatElapsedDuration(o)} ago` : "No recent property activity recorded"}
          </div>
        </div>
          ...
          <div class="config-row">
            ...
            <div class="config-value">
              <input
                ...
                @change=${(c) => this._setRecentActivityDraft({
      ...t,
      enabled: c.target.checked
    })}
              />
            </div>
          </div>
          <div class="config-row">
            ...
            <div class="config-value">
              <input
                ...
                max=${24 * 30}
                step="1"
                .value=${String(t.window_hours || 48)}
                ?disabled=${r || !t.enabled}
                data-testid="recent-activity-window-hours"
                @change=${(c) => this._setRecentActivityDraft({
      ...t,
      window_hours: Number(c.target.value)
    })}
              />
            </div>
          </div>
          <div class="config-row">
            ...
            <div class="config-value">
              <input
                type="checkbox"
                class="switch-input"
                .checked=${!!t.include_descendant_occupancy}
                ?disabled=${r || !t.enabled}
                data-testid="recent-activity-descendant-occupancy-toggle"
                @change=${(c) => this._setRecentActivityDraft({
      ...t,
      include_descendant_occupancy: c.target.checked
    })}
              />
            </div>
          </div>
        ...
        ${this._recentActivitySaveError ? g`<div class="policy-warning">${this._recentActivitySaveError}</div>` : ""}
        ${this._recentActivityDraftDirty ? g`
  ...
  _isAmbientStateChangeRelevant(t, e, i) {
    ...
    const n = this._getAmbientConfig(), o = String(((h = this._ambientReading) == null ? void 0 : h.source_sensor) || "").trim(), a = String(n.lux_sensor || "").trim(), r = String(((_ = this._ambientReading) == null ? void 0 : _.fallback_method) || "").toLowerCase(), c = !!n.fallback_to_sun || r.includes("sun"), l = new Set(this._normalizeAmbientLocalLuxLightEntityIds(n));
    if (t === "sun.sun" && c || l.has(t))
      return !0;
    ...
    return g`
      <div class="card-section" data-testid="ambient-section">
        ...
        <div class="ambient-grid">
          ...
          <div class="ambient-value" data-testid="ambient-state">${A}</div>
          <div class="ambient-key">Configured source</div>
          <div class="ambient-value" data-testid="ambient-configured-source">${L}</div>
        ...
        <div class="policy-note" data-testid="ambient-source-priority-note">${f}</div>
        ${d ? g`<div class="policy-note" data-testid="ambient-local-light-summary">
              Local lights checked for lux contamination: ${p}
            </div>` : ""}
        ...
        <div class="config-row">
          ...
          <div class="config-value">
            <select
              ...
              @change=${(x) => {
      const D = x.target.value.trim();
      this._setAmbientDraft({
        ...t,
        lux_sensor: D || null,
        inherit_from_parent: !D,
        local_lux_light_entity_ids: D ? t.local_lux_light_entity_ids || [] : []
      }), this._scheduleAmbientReadingReload();
    }}
            >
              <option value="" ?selected=${C === ""}>${I}</option>
              ${i.map(
      (x) => g`<option value=${x} ?selected=${C === x}>
                    ${this._entityName(x)}
                  </option>`
    )}
            </select>
        ...
        <div class="config-row">
          <div>
            ...
            <div class="config-help">Dark when lux is below this value.${y}</div>
          </div>
          <div class="config-value">
            <input
              type="number"
              ...
              @change=${(x) => {
      const D = Math.max(0, Number(x.target.value) || 0);
      this._setAmbientDraft({
        ...t,
        dark_threshold: D,
        bright_threshold: Math.max(D + 1, Number(t.bright_threshold) || D + 1)
      }), this._scheduleAmbientReadingReload();
    }}
            />
          </div>
        ...
        <div class="config-row">
          <div>
            ...
            <div class="config-help">Bright when lux is above this value.${y}</div>
          </div>
          <div class="config-value">
            <input
              type="number"
        ...
        ${d ? g`
              <div class="config-row ambient-light-selector-row">
                ...
                <div class="config-value ambient-light-selector" data-testid="ambient-local-light-selector">
                  ${h.length === 0 ? g`<div class="text-muted">No local light entities are assigned to this location.</div>` : h.map((x) => {
      const D = _.has(x);
      return g`
                          <label class="ambient-light-option">
                            <input
                              ...
                              .checked=${D}
                              ?disabled=${T}
                              data-testid=${`ambient-local-light-${x}`}
                              @change=${(W) => {
        const K = new Set(t.local_lux_light_entity_ids || []);
        W.target.checked ? K.add(x) : K.delete(x);
        const q = [...K].sort(
          (Q, Z) => this._entityName(Q).localeCompare(this._entityName(Z))
        );
        this._setAmbientDraft({
          ...t,
          local_lux_light_entity_ids: q,
          fallback_to_sun: !0
        }), this._scheduleAmbientReadingReload();
      }}
                            />
                            <span>${this._entityName(x)}</span>
                            <span class="source-state-pill ${this._entityStateBadgeTone(x)}"
                              >${this._entityState(x)}</span
                            >
                          </label>
                        `;
    })}
  ...
  _ambientInheritedSourceLocationId(t) {
    var n, o;
    const e = typeof (t == null ? void 0 : t.source_location) == "string" ? t.source_location.trim() : "";
    if (e && e !== ((n = this.location) == null ? void 0 : n.id) && this._locationById(e))
      return e;
    const i = typeof ((o = this.location) == null ? void 0 : o.parent_id) == "string" ? this.location.parent_id : "";
    return i && this._locationById(i) ? i : "";
  }
  _selectLocation(t) {
  ...
  _currentManagedShadowAreaId() {
    return !this._isManagedShadowHost() || !this.location ? "" : Ue(this.location);
  }
  ...
  _runtimeProjectionLocationId() {
    var t;
    return ((t = this.location) == null ? void 0 : t.id) || "";
  }
  ...
  _occupancyGroupCandidatesForLocation(t) {
    ...
    return i ? (this.allLocations || []).filter((n) => n.parent_id === i.id).filter((n) => z(n) === "area").filter((n) => !this._isManagedShadowLocation(n, e)).sort((n, o) => n.name.localeCompare(o.name)) : [];
  }
  ...
  _floorOccupancyGroups() {
    ...
    for (const o of t) {
      ...
      const c = [...r].sort((l, d) => this._locationName(l).localeCompare(this._locationName(d)));
      n.push({
        id: a,
        memberIds: c
      });
  ...
  async _persistFloorOccupancyGroups(t, e) {
    ...
    try {
      for (const a of i) {
        const r = this._persistedOccupancyConfigForLocation(a), c = o.find((d) => d.memberIds.includes(a.id)), l = this._sanitizeOccupancyConfig(
          {
            ...r,
      ...
      <div class="card-section" data-testid="occupancy-groups-section">
        ...
        ${t.length === 0 ? g`<div class="adjacency-empty">No eligible direct child areas found on ${o}.</div>` : g`
              <div class="linked-location-list">
                ${e.length === 0 ? g`<div class="adjacency-empty">No occupancy groups on ${o} yet.</div>` : me(
      e,
      (c) => c.id,
      (c, l) => g`
                        <div class="card-section" data-testid=${`occupancy-group-card-${l + 1}`}>
                          ...
                          <div class="linked-location-list">
                            ${t.map((d) => {
        const u = c.memberIds.includes(d.id);
        return g`
                                <div class="linked-location-row">
                                  <label class="linked-location-left">
                                    <input
                                      type="checkbox"
                                      data-testid=${`occupancy-group-${l + 1}-location-${d.id}`}
                                      .checked=${u}
                                      ?disabled=${this._savingOccupancyDraft}
                                      @change=${(h) => {
          const _ = h.target;
          this._toggleFloorGroupMembership(
            ...
            _.checked
                                    ...
                                    />
                                    <span class="linked-location-name">${d.name}</span>
                                  </label>
                                </div>
                              `;
      })}
                          ...
                          <div class="linked-location-row">
                            <label class="linked-location-left">
                              <input
                                ...
                                @change=${(l) => {
      const d = l.target;
      this._toggleFloorCreateSelection(c, d.checked);
    }}
                              />
  ...
  _renderAreaSensorList(t) {
    ...
    const c = [...o].sort(
    ...
    ), l = c, d = new Set(c.map((f) => f.key)), u = i.filter((f) => !d.has(this._sourceKeyFromSource(f))).map((f) => ({
      ...
      if (y !== 0) return y;
      const A = this._signalSortWeight(f.signalKey) - this._signalSortWeight(m.signalKey);
      if (A !== 0) return A;
    ...
    for (const f of h) {
      ...
      const A = { key: m, items: [f] };
      p.set(m, A), _.push(A);
    }
    return _.sort((f, m) => {
      var b, C;
      const y = ((b = f.items[0]) == null ? void 0 : b.entityId) ?? "", A = ((C = m.items[0]) == null ? void 0 : C.entityId) ?? "", w = this._entityName(y).localeCompare(this._entityName(A));
      ...
      return g`
            <div class="source-card ${m ? "enabled" : ""}">
              ${me(f.items, (y) => y.key, (y, A) => {
        const w = n.get(y.key), b = w !== void 0, C = b ? i[w] : void 0, I = b && C ? C : void 0, L = this._modeOptionsForEntity(y.entityId);
        return g`
                  <div class=${`source-card-item${A > 0 ? " grouped" : ""}`}>
          ...
          x && !b ? this._addSourceWithDefaults(y.entityId, t, {
            resetExternalPicker: !1,
            signalKey: y.signalKey
          }) || this.requestUpdate() : !x && b && this._removeSource(w, t);
        }}
                        />
                      </div>
                      <div>
                            ...
                            ${b && I && L.length > 1 ? g`
                                  <div class="inline-mode-group">
                                    ...
                                    <select
                                      ...
                                      .value=${L.some((T) => T.value === I.mode) ? I.mode : L[0].value}
                                      @change=${(T) => {
          const x = T.target.value, D = this.hass.states[y.entityId], W = ni(I, x, D);
          this._updateSourceDraft(t, w, { ...W, entity_id: I.entity_id });
        }}
                                    >
                                      ${L.map((T) => g`<option value=${T.value}>${T.label}</option>`)}
                                    </select>
                                  </div>
                                ` : ""}
                          </div>
  ...
  _renderIntegratedLightCard(t, e, i, n) {
    ...
    if (!o) return "";
    const a = [...e].filter((p) => this._isLightSignalKey(p.signalKey)).sort((p, f) => this._signalSortWeight(p.signalKey) - this._signalSortWeight(f.signalKey));
    if (a.length === 0) return "";
    const r = a.filter((p) => n.has(p.key)), c = r.length > 0, l = r.find((p) => p.signalKey === "power") || r[0] || a[0], d = n.get(l.key), u = d !== void 0 ? i[d] : void 0, h = this._modeOptionsForEntity(o);
    return g`
        ...
        t
            ...
            <div>
              <div class="candidate-headline">
                ...
                <div class="candidate-controls">
                  <span class=${`source-state-pill ${this._entityStateBadgeTone(o)}`}>${this._entityState(o)}</span>
                  ${u && d !== void 0 && h.length > 1 ? g`
                        <div class="inline-mode-group">
                          <span class="inline-mode-label">Mode</span>
                          <select
                            class="inline-mode-select"
                            ...
                            @change=${(p) => {
      const f = p.target.value, m = this.hass.states[o], y = ni(u, f, m);
  ...
  _renderIntegratedMediaCard(t, e, i, n) {
    ...
    const o = (_ = e[0]) == null ? void 0 : _.entityId;
    if (!o) return "";
    const a = [...e].filter((p) => this._isMediaSignalKey(p.signalKey)).sort((p, f) => this._signalSortWeight(p.signalKey) - this._signalSortWeight(f.signalKey));
    if (a.length === 0) return "";
    const r = a.filter((p) => n.has(p.key)), c = r.length > 0, l = r.find((p) => p.signalKey === "playback") || r[0] || a[0], d = n.get(l.key), u = d !== void 0 ? i[d] : void 0, h = this._modeOptionsForEntity(o);
    return g`
      <div class="source-card ${c ? "enabled" : ""}">
        <div class="source-card-item">
          <div class="candidate-item">
  ...
  _areaSourceCandidateKeys(t) {
    if (!this.location) return /* @__PURE__ */ new Set();
    const e = new Set(this.location.entity_ids || []);
    if (this.location.ha_area_id)
      for (const o of this._entitiesForArea(this.location.ha_area_id))
        e.add(o);
    const n = [...e].filter((o) => this._isCoreAreaSourceEntity(o)).sort((o, a) => this._entityName(o).localeCompare(this._entityName(a))).flatMap(
      (o) => this._candidateItemsForEntity(o)
    );
    return new Set(n.map((o) => o.key));
  }
  _externalDraftSources(t) {
    const e = this._areaSourceCandidateKeys(t);
    return this._workingSources(t).filter(
      (i) => !e.has(this._sourceKeyFromSource(i))
    );
  }
  _renderExternalSourceAddedList(t) {
    const e = this._externalDraftSources(t);
    return e.length ? g`
      <div class="external-source-added-section" data-testid="external-source-added-section">
        ...
        <ul class="external-source-added-list" data-testid="external-source-added-list">
          ${e.map((i) => {
      const n = i.entity_id, o = this._sourceKeyFromSource(i);
      return g`
              <li class="external-source-added-item" data-testid="external-source-added-item">
                <div class="external-source-added-meta">
                  <div class="external-source-added-name">${this._entityName(n)}</div>
                  <div class="candidate-submeta">
                    Current state:
                    <span class=${`source-state-pill ${this._entityStateBadgeTone(n)}`}>
                      ${this._entityState(n)}
                    </span>
                  </div>
                </div>
                <button
                  ...
                  data-source-key=${o}
                  ?disabled=${this._savingOccupancyDraft}
                  @click=${() => this._removeSourcesByKey([o], this._getOccupancyConfig())}
                >
                  Remove
                </button>
              </li>
  ...
  _renderExternalSourceComposer(t) {
    var h, _;
    const e = this._availableSourceAreas(), i = this._isSiblingAreaSourceScope(), n = ((h = this.location) == null ? void 0 : h.ha_area_id) || "", o = !!n, a = this._externalAreaId || "", r = a ? a === "__this_area__" ? n ? this._entitiesForArea(n) : [] : this._entitiesForArea(a) : [], c = new Set(this._workingSources(t).map((p) => this._sourceKeyFromSource(p))), l = this._externalEntityId || "", d = i ? "Sibling Area" : (_ = this.location) != null && _.ha_area_id ? "Other Area" : "Source Area", u = i ? "Select sibling area..." : "Select area...";
    return g`
      ...
      this._externalEntityId = p.target.value, this.requestUpdate();
          ...
          ${l ? g`
                <div class="candidate-submeta">
                  Current state:
                  <span class=${`source-state-pill ${this._entityStateBadgeTone(l)}`}>
                    ${this._entityState(l)}
                  </span>
                </div>
              ` : ""}
  ...
  _renderExternalSourceDialog() {
    ...
    const t = this._getOccupancyConfig(), e = this._isSiblingAreaSourceScope(), i = !!this.location.ha_area_id, n = this._canAddSelectedExternalSource(t);
    return g`
      <ha-dialog
      ...
      >
        <div class="external-source-dialog-content">
          ...
          ${this._renderExternalSourceAddedList(t)}
          <div class="external-source-dialog-actions">
            ...
            <button
              ...
              ?disabled=${this._savingOccupancyDraft || !n}
  ...
  _renderWiabSection(t) {
    var d, u, h, _;
    const e = this._getWiabConfig(t), i = this._wiabInteriorCandidates(), n = this._wiabDoorCandidates(), o = ((d = this.location) == null ? void 0 : d.ha_area_id) || "", a = o ? ((_ = (h = (u = this.hass) == null ? void 0 : u.areas) == null ? void 0 : h[o]) == null ? void 0 : _.name) || o : "", r = !!o && !this._wiabShowAllEntities, c = e.preset || "off";
    return g`
      <div class="card-section">
        <div class="section-title">
  ...
  _renderSourceEditor(t, e, i) {
    const n = e, o = this._eventLabelsForSource(e), a = this._sourceKeyFromSource(e), r = this._supportsOffBehavior(e), c = this._isStateHeldPresenceSource(n), l = t.default_timeout || 300, d = this._onTimeoutMemory[a], u = n.on_timeout === null ? d ?? l : n.on_timeout ?? d ?? l, h = Math.max(1, Math.min(120, Math.round(u / 60))), _ = n.off_trailing ?? 0, p = Math.max(0, Math.min(120, Math.round(_ / 60)));
    return g`
        ...
        [a]: m * 60
                  ...
                  <label class="editor-toggle">
                    <input
                      ...
                      @change=${(f) => {
      const m = f.target.checked, y = this._onTimeoutMemory[a], A = h * 60, w = y ?? A;
  ...
  _autoActionRuleName(t, e) {
    const n = this._normalizeActionTriggerTypes(t.trigger_types, t.trigger_type).map((d) => this._autoRuleTriggerWord(d));
    ...
    if (t.require_property_activity && (o = o ? `${o} while property active` : "While property active"), !o)
      return "New rule";
    const a = this._actionTargetsForRule(t), r = a[0], c = String((r == null ? void 0 : r.entity_id) || "").trim();
    if (!c)
      return `${o} (${e + 1})`;
  ...
  _normalizeActionTargets(t, e) {
    ...
    for (const o of t) {
      ...
      const c = String(o.service || "").trim() || this._defaultActionServiceForTrigger(a, e), l = this._normalizeActionDataForRule(
        ...
        a,
        c
      ), d = this._actionSupportsOnlyIfOff(a, c) && typeof o.only_if_off == "boolean" ? !!o.only_if_off : void 0;
      i.push({
        entity_id: a,
        service: c,
        ...l ? { data: l } : {},
  ...
  _setActionTargetsForRule(t, e) {
    ...
    return {
      actions: this._normalizeActionTargets(e, i)
    };
  }
  ...
  _defaultActionServiceForTrigger(t, e) {
    ...
    return i === "media_player" ? n ? "media_stop" : "media_play" : i === "switch" || i === "light" ? n ? "turn_off" : "turn_on" : i === "vacuum" ? e === "on_occupied" ? "pause" : "start" : n ? "turn_off" : "turn_on";
  }
  ...
  _ruleTabForEditing(t) {
    var n;
    const e = String(((n = this._actionTargetsForRule(t)[0]) == null ? void 0 : n.entity_id) || "").trim();
    if (e)
  ...
  _normalizeActionDataForRule(t, e, i) {
    ...
    delete a.entity_id;
    const r = n.startsWith("light.") && this._isDimmableEntity(n) && o === "turn_on", c = n.startsWith("media_player.") && o === "volume_mute", l = n.startsWith("media_player.") && o === "volume_set", d = n.startsWith("fan.") && o === "set_percentage";
  ...
  _actionServiceOptionsForRule(t, e) {
    ...
    if (n === "media_player") {
      ...
      return a.sort((c, l) => {
        const d = r.indexOf(c.value), u = r.indexOf(l.value);
        return d >= 0 || u >= 0 ? d < 0 ? 1 : u < 0 ? -1 : d - u : c.label.localeCompare(l.label);
      });
    }
    if (n === "fan") {
      const a = [
    ...
    if (n === "vacuum") {
      ...
      return a.sort((c, l) => c.service === r ? -1 : l.service === r ? 1 : 0);
    }
  ...
  _actionDomainsForTab(t) {
    return t === "lighting" ? ["light"] : t === "media" ? ["media_player"] : t === "appliances" ? ["fan", "switch"] : t === "vacuum" ? ["vacuum"] : ["fan"];
  }
  ...
  _isActionRuleEntity(t, e) {
    ...
    const n = t.split(".", 1)[0];
    return e ? e === "hvac" ? n !== "fan" ? !1 : (this._climateDeviceLinkRevision, this._fanEntityLinkedToClimate(t)) : e === "appliances" ? n === "switch" ? !0 : n === "fan" ? (this._climateDeviceLinkRevision, !this._fanEntityLinkedToClimate(t)) : !1 : this._actionDomainsForTab(e).includes(n) : n === "light" || n === "switch" || n === "media_player" || n === "fan" || n === "vacuum";
  }
  ...
  _normalizeActionRule(t, e) {
    ...
    ), n = this._primaryActionTriggerType(i), o = typeof t.id == "string" && t.id.trim().length > 0 ? t.id : `action_rule_${e + 1}`, r = this._actionTargetsForRule(t), c = this._normalizeRuleUuid(t.rule_uuid, o), l = typeof t.run_on_startup == "boolean" ? t.run_on_startup : this._isLightingActionRule(t);
    return {
      id: o,
      ...
      require_property_activity: this._isLightingActionRule(t) && !!t.require_property_activity,
      time_condition_enabled: !!t.time_condition_enabled,
      ...
      daily_gating_enabled: typeof t.daily_gating_enabled == "boolean" ? t.daily_gating_enabled : !1,
      enabled: t.enabled !== !1
    };
  }
  _isLightingActionRule(t) {
    var n;
    const e = this._actionTargetsForRule(t);
    return String(((n = e[0]) == null ? void 0 : n.entity_id) || "").trim().startsWith("light.");
  }
  _workingActionRules() {
  ...
  _rulesForDeviceAutomationTab(t) {
    return this._workingActionRules().filter((i) => {
      var a;
      const n = String(((a = this._actionTargetsForRule(i)[0]) == null ? void 0 : a.entity_id) || "").trim();
  ...
  _resetActionRulesDraftFromLoaded() {
    ...
    const t = this._actionRules.map(
      (i, n) => this._normalizeActionRule(i, n)
    );
    ...
    for (const i of t) {
      const n = String(i.id || ""), o = this._tabForActionEntity(String(((e = this._actionTargetsForRule(i)[0]) == null ? void 0 : e.entity_id) || "").trim());
      n && o && (this._actionRuleTabById[n] = o);
    }
  }
  _setActionRulesDraft(t) {
    var o;
    const e = t.map((a, r) => this._normalizeActionRule(a, r)), i = new Set(e.map((a) => String(a.id || ""))), n = {};
    for (const [a, r] of Object.entries(this._actionRuleTabById))
      i.has(a) && (n[a] = r);
    for (const a of e) {
      const r = String(a.id || ""), c = this._tabForActionEntity(String(((o = this._actionTargetsForRule(a)[0]) == null ? void 0 : o.entity_id) || "").trim());
      r && c && (n[r] = c);
    }
  ...
  _actionRuleComparableSignature(t, e) {
    ...
    return JSON.stringify({
      ...
      run_on_startup: !!i.run_on_startup,
      enabled: i.enabled !== !1
    });
  }
  ...
  _rebuildActionRulesDraftAfterSync(t, e, i = {}) {
    const n = t.map((l, d) => this._normalizeActionRule(l, d)), o = this._actionRuleLookup(n), a = [...n], r = i.ruleIds || /* @__PURE__ */ new Set(), c = i.ruleUuids || /* @__PURE__ */ new Set();
    for (const [l, d] of e.entries()) {
      const u = this._normalizeActionRule(d, l), h = String(u.id || "").trim(), _ = this._normalizeRuleUuid(u.rule_uuid, h);
      if (r.has(h) || c.has(_))
        continue;
      const p = (h ? o.byId.get(h) : void 0) || (_ ? o.byRuleUuid.get(_) : void 0);
      if (!p) {
        a.push(u);
        continue;
      }
      const f = a.findIndex((m) => String(m.id || "") === String(p.id || ""));
      f < 0 || this._isActionRuleDirty(u, f, p) && (a[f] = this._normalizeActionRule(
        {
          ...u,
          id: p.id,
  ...
  _mergeSavedActionRuleLocally(t, e, i) {
    ...
    r.push(n);
    const c = e.filter((l) => String(l.id || "").trim() !== i).map((l, d) => this._normalizeActionRule(l, d));
  ...
  _addActionRule(t) {
    try {
      const e = this._workingActionRules(), n = this._actionRuleTargetEntities(t)[0] || "", a = t === "lighting" ? [] : [t === "media" || t === "vacuum" ? "on_vacant" : "on_occupied"], r = this._primaryActionTriggerType(a), c = `action_rule_${Date.now()}_${Math.floor(Math.random() * 1e3)}`;
      ...
      const l = {
        ...
        require_property_activity: !1,
        time_condition_enabled: !1,
        start_time: "18:00",
        end_time: "23:59",
        run_on_startup: !1,
        user_named: !1,
        daily_gating_enabled: !1,
        enabled: !0
      };
    ...
    const i = this._workingActionRules().map((n, o) => {
      ...
      if (Object.prototype.hasOwnProperty.call(e, "trigger_type") || Object.prototype.hasOwnProperty.call(e, "trigger_types")) {
        ...
        if (r.trigger_type = u, r.trigger_types = d, !Object.prototype.hasOwnProperty.call(e, "ambient_condition")) {
          const h = this._defaultActionAmbientConditionForTrigger(a), _ = this._defaultActionAmbientConditionForTrigger(d);
          r.ambient_condition = this._normalizeActionAmbientCondition(r.ambient_condition, a) === h ? _ : this._normalizeActionAmbientCondition(r.ambient_condition, d);
        }
        Object.prototype.hasOwnProperty.call(e, "actions") || (c = c.map((h) => {
          const _ = this._defaultActionServiceForTrigger(h.entity_id, u), p = this._normalizeActionDataForRule(
            h.data,
            h.entity_id,
            _
          );
      ...
      Object.prototype.hasOwnProperty.call(e, "actions") && (c = this._normalizeActionTargets(
        e.actions,
      ...
      return r.actions = l.actions, this._maybeSyncActionRuleNameFromStructure(
        n,
        r,
        o,
        e
  ...
  _actionRuleValidationErrors(t) {
    ...
    return t.forEach((n, o) => {
      ...
      c.length === 0 && e.push(`${a}: select at least one target device.`), c.some((d) => !d.service) && e.push(`${a}: select an action service for each target.`), n.time_condition_enabled && (i.test(String(n.start_time || "")) || e.push(`${a}: begin time must be HH:MM.`), i.test(String(n.end_time || "")) || e.push(`${a}: end time must be HH:MM.`));
    }), e;
  }
  async _saveActionRulesDraft() {
    ...
    try {
      ...
      for (const [l, d] of t.entries()) {
        const u = this._normalizeActionRule(d, l), h = this._actionTargetsForRule(u);
        if (!h[0]) continue;
        const p = n.get(String(u.id || "")) || o.get(
          this._normalizeRuleUuid(u.rule_uuid, u.id)
        ), f = this._ruleTabForEditing(u), m = this._effectiveAmbientConditionForRule(u, f), y = this._sanitizedTriggersForManagedSave(u, f), A = p ? String(p.id || "") : void 0, w = await pn(
          this.hass,
          {
            location: this.location,
            name: u.name || "New rule",
            rule_uuid: u.rule_uuid,
            automation_id: A || void 0,
            trigger_type: y.trigger_type,
            trigger_types: y.trigger_types,
            actions: h,
            ambient_condition: m,
            must_be_occupied: u.must_be_occupied,
            require_property_activity: f === "lighting" && this._canRequirePropertyActivity() && !!u.require_property_activity,
            time_condition_enabled: !!u.time_condition_enabled,
            start_time: u.start_time,
            end_time: u.end_time,
            user_named: !!u.user_named
          },
          this.entryId
        );
        a.add(String(w.id || ""));
      }
      const r = i.filter((l) => !a.has(String(l.id || ""))).map((l) => gn(this.hass, l, this.entryId));
  ...
  async _saveOrUpdateActionRule(t) {
    ...
    this._savingActionRules = !0, this._actionRulesSaveError = void 0, this.requestUpdate();
    try {
      const r = this._actionTargetsForRule(n), c = r[0], l = this._ruleTabForEditing(n), d = this._effectiveAmbientConditionForRule(n, l), u = this._sanitizedTriggersForManagedSave(n, l);
      if (!c)
      ...
      const h = await pn(
        this.hass,
        {
          ...
          require_property_activity: l === "lighting" && this._canRequirePropertyActivity() && !!n.require_property_activity,
          time_condition_enabled: !!n.time_condition_enabled,
          start_time: n.start_time,
          end_time: n.end_time,
          run_on_startup: l === "lighting" ? !!n.run_on_startup : !1,
          user_named: !!n.user_named,
          daily_gating_enabled: mi(
            n.daily_gating_enabled,
            r
          )
        },
        this.entryId
  ...
  async _deleteActionRule(t) {
    ...
    this._savingActionRules = !0, this._actionRulesSaveError = void 0, this.requestUpdate();
    try {
      await gn(this.hass, o, this.entryId);
      const a = await _e(this.hass, this.location.id, this.entryId);
  ...
  _renderLightingRuleActionRows(t, e, i, n) {
    const o = this._actionTargetsForRule(e), a = new Map(o.map((c) => [c.entity_id, c])), r = [.../* @__PURE__ */ new Set([...n, ...o.map((c) => c.entity_id)])].filter((c) => c.trim().length > 0).sort((c, l) => this._entityName(c).localeCompare(this._entityName(l)));
    return r.length === 0 ? g`<div class="text-muted">No local lights found for this location.</div>` : g`
      <div class="dusk-light-actions" data-testid=${`action-rule-${t}-actions`}>
        ${r.map((c, l) => {
      const d = a.get(c), u = !!d, h = this._isDimmableEntity(c), _ = this._defaultActionServiceForTrigger(
        c,
        this._primaryActionTriggerType(
        ...
        100
      ), y = this._actionSupportsOnlyIfOff(c, p), A = y ? !!(d != null && d.only_if_off) : !1, w = u ? p === "turn_off" ? "off" : p === "toggle" ? "toggle" : "on" : _ === "turn_off" ? "off" : "on", b = u && p === "turn_off" ? 0 : m, C = (L) => {
        const T = o.map((Z) => ({ ...Z })), x = T.findIndex((Z) => Z.entity_id === c), D = x >= 0 ? { ...T[x] } : {
          service: _
        }, K = String(L.service ?? D.service ?? "").trim() || _, q = this._normalizeActionDataForRule(
          L.data ?? D.data,
          c,
          K
        ), Q = {
          ...
          service: K,
          ...q ? { data: q } : {},
          ...this._actionSupportsOnlyIfOff(c, K) && typeof (L.only_if_off ?? D.only_if_off) == "boolean" ? { only_if_off: !!(L.only_if_off ?? D.only_if_off) } : {}
        };
        x >= 0 ? T[x] = Q : T.push(Q), this._updateActionRule(t, { actions: T });
      }, I = () => {
        this._updateActionRule(t, {
          actions: o.filter((L) => L.entity_id !== c)
        });
      };
      return g`
            ...
            brightness_pct: m
                ...
                <div class="dusk-light-entity-meta">
                  <span class="dusk-light-entity-title">
                    ...
                    <span class=${`entity-state-badge ${this._entityStateBadgeTone(c)}`}>
                      ${this._entityStateLabel(c)}
                    </span>
                  </span>
                  <code>${c}</code>
                </div>
                ${h ? g`
                      <label class="dusk-level-control">
                        <input
                          ...
                          @input=${(L) => {
        const T = Number(L.target.value), x = Number.isFinite(T) ? Math.max(0, Math.min(100, Math.round(T))) : m;
        if (x <= 0) {
          C({
            service: "turn_off",
            data: {}
                    ...
                    ` : g`
                      <div class="dusk-light-action-switch">
                        <select
                          ...
                          @change=${(L) => {
        const T = String(L.target.value || "on"), x = T === "off" ? "turn_off" : T === "toggle" ? "toggle" : "turn_on";
        C({
          service: x,
          data: {},
          ...x === "turn_on" ? {} : { only_if_off: void 0 }
        });
      }}
                        >
  ...
  _renderLightingRuleEditor(t, e, i, n) {
    const o = this._ancestorPropertyWithRecentActivity();
    return g`
      ${this._renderLightingTriggerRows(t, e, i)}

      ${o ? g`
            <div class="dusk-rule-section-title">Only if</div>
            <label class="startup-inline-toggle" data-testid=${`action-rule-${t}-property-activity`}>
              <input
                type="checkbox"
                class="switch-input"
                .checked=${!!e.require_property_activity}
                ?disabled=${i}
                @change=${(a) => this._updateActionRule(t, {
      require_property_activity: a.target.checked
    })}
              />
              <span>${o.name || "Property"} is recently active</span>
            </label>
          ` : ""}
      ...
      <div class="startup-inline" data-testid=${`action-rule-${t}-startup`}>
        <label class="startup-inline-toggle">
          <input
            type="checkbox"
            class="switch-input"
            .checked=${!!e.run_on_startup}
            ?disabled=${i}
            data-testid=${`action-rule-${t}-run-on-startup`}
            @change=${(a) => this._updateActionRule(t, {
      run_on_startup: a.target.checked
    })}
          />
  ...
  _renderMediaOccupancyOnlyActionsBlock(t, e, i, n) {
    const o = this._normalizeActionTriggerTypes(e.trigger_types, e.trigger_type), a = this._primaryActionTriggerType(o), r = this._actionTargetsForRule(e)[0], c = String((r == null ? void 0 : r.entity_id) || "").trim(), l = this._normalizeActionDataForRule(
      r == null ? void 0 : r.data,
      c,
      String((r == null ? void 0 : r.service) || "")
    ), d = this._actionServiceOptionsForRule(c, a), u = this._actionServiceOptionValue(
      r == null ? void 0 : r.service,
      l
    ), h = c.startsWith("media_player.") && u === "volume_set";
    return g`
      ...
      (_) => this._renderChoicePill(
        ...
        () => {
          if (c === _) return;
          const p = this._defaultActionServiceForTrigger(_, a);
          this._updateActionRule(t, {
            actions: [{ entity_id: _, service: p }]
          });
        },
        this._entityStateLabel(_)
      )
    )}
                  </div>
                `}
      ...
      (_) => this._renderChoicePill(
        ...
        () => {
          if (u === _.value) return;
          const p = this._actionServiceSelection(
            _.value,
            c,
            a
          );
                ...
                <div class="config-value">
                  <div class="dusk-slider-row">
                    <input
                      ...
                      ?disabled=${i}
                      @input=${(_) => {
      const p = this._normalizeActionPercent(
        _.target.value,
        30
      );
      this._updateActionRule(t, {
        actions: [
          {
            entity_id: c,
            service: String((r == null ? void 0 : r.service) || "volume_set"),
            data: { volume_level: p / 100 }
          }
        ]
      });
    }}
  ...
  _renderEquipmentPillActionsBlock(t, e, i, n, o) {
    const a = this._normalizeActionTriggerTypes(i.trigger_types, i.trigger_type), r = this._primaryActionTriggerType(a), c = this._actionTargetsForRule(i)[0], l = String((c == null ? void 0 : c.entity_id) || "").trim(), d = this._normalizeActionDataForRule(
      c == null ? void 0 : c.data,
      l,
      String((c == null ? void 0 : c.service) || "")
    ), u = this._actionServiceOptionsForRule(l, r), h = this._actionServiceOptionValue(
      c == null ? void 0 : c.service,
      d
    ), _ = l.startsWith("fan.") && h === "set_percentage", p = t === "hvac" ? "hvac-rule-actions" : t === "vacuum" ? "vacuum-rule-actions" : "appliances-rule-actions", f = t === "hvac" ? `hvac-equip-target-${e}` : t === "vacuum" ? `vacuum-equip-target-${e}` : `appl-equip-target-${e}`, m = t === "hvac" ? `hvac-equip-cmd-${e}` : t === "vacuum" ? `vacuum-equip-cmd-${e}` : `appl-equip-cmd-${e}`, y = t === "hvac" ? "Equipment" : t === "vacuum" ? "Vacuum" : "Device", A = t === "hvac" ? "No HVAC-linked fans in this location." : t === "vacuum" ? "No vacuums in this location." : "No fans or switches in this location.";
    return g`
      <div class="dusk-equipment-actions" data-testid=${p}>
        ...
        <div class="dusk-rule-row dusk-media-actions-row">
          ...
          <div class="config-value">
            ${o.length === 0 ? g`<div class="text-muted">${A}</div>` : g`
      ...
      (w) => this._renderChoicePill(
        ...
        () => {
          ...
          t === "vacuum" && b.service !== "start" && i.daily_gating_enabled && (C.daily_gating_enabled = !1), this._updateActionRule(e, C);
        }
      )
    )}
                  </div>
                ` : g`<div class="text-muted">Choose ${t === "hvac" ? "equipment" : t === "vacuum" ? "a vacuum" : "a device"} first.</div>`}
          </div>
        </div>
        ${_ ? g`
              <div class="dusk-rule-row">
        ...
        actions: [
          {
            ...
            data: { percentage: b }
                    ...
                    />
                    <span class="text-muted">${this._fanSpeedPercent(d)}%</span>
                  </div>
                </div>
              </div>
            ` : ""}
  ...
  _renderOccupancyOnlyActionsBlock(t, e, i, n, o) {
    return t === "media" ? this._renderMediaOccupancyOnlyActionsBlock(e, i, n, o) : t === "hvac" ? this._renderEquipmentPillActionsBlock("hvac", e, i, n, o) : t === "appliances" ? this._renderEquipmentPillActionsBlock("appliances", e, i, n, o) : t === "vacuum" ? this._renderEquipmentPillActionsBlock("vacuum", e, i, n, o) : g``;
  }
  _renderOccupancyOnlyRuleEditor(t, e, i, n, o) {
    return g`
      ...
      ${t === "vacuum" && Jn(this._actionTargetsForRule(i)) ? g`
            ${this._renderDailyGatingPills(e, i, n)}
            ${this._renderVacuumDailyRunStatus(i)}
          ` : ""}
      ${this._renderOccupancyOnlyActionsBlock(t, e, i, n, o)}
    `;
  }
  /** ADR-HA-091: opt-in once-per-day gating for vacuum.start rules only. */
  _renderVacuumDailyRunStatus(t) {
    if (!mi(t.daily_gating_enabled, this._actionTargetsForRule(t)))
      return g``;
    const e = Ha(t), i = qa(this.hass, e);
    return g`
  ...
  _renderDailyGatingPills(t, e, i) {
    const n = !!e.daily_gating_enabled;
    return g`
      <div class="dusk-inline-heading-row">
  ...
  _renderDeviceAutomationTab(t) {
    ...
    const e = this._savingActionRules, i = this._deviceAutomationTabMeta(t), n = this._rulesForDeviceAutomationTab(t), o = this._actionRuleTargetEntities(t), a = t === "lighting" ? "light" : t === "appliances" ? "fan or switch" : t === "media" ? "media" : t === "vacuum" ? "vacuum" : "HVAC-linked fan", r = n.some((c, l) => {
      const d = this._persistedActionRuleForDraft(c);
      return !d || this._isActionRuleDirty(c, l, d);
    });
    return g`
      <div class="card-section" data-testid="actions-rules-section">
        ...
        <div class="dusk-block-list">
          ${n.length === 0 ? g`
              ...
              ` : n.map((c, l) => {
      const d = String(c.id || ""), u = this._resolveActionRuleName(c, l), h = this._persistedActionRuleForDraft(c), _ = !!h, p = this._isActionRuleDirty(c, l, h);
      return g`
                  <div class="dusk-block-row" data-testid=${`action-rule-${d}`}>
                    <div class="dusk-block-head">
                      <button
                        ...
                        ?disabled=${e}
                        @click=${() => this._startActionRuleNameEdit(d, u)}
                      >
                        ${u}
                      </button>
                    </div>
        ...
        e,
        o
      ) : this._renderOccupancyOnlyRuleEditor(t, d, c, e, o)}
  ...
  _confirmExternalSourceSelection() {
    const t = this._getOccupancyConfig(), e = this._externalEntityId.trim();
  ...
  _normalizeSource(t, e) {
    ...
    const d = e.source_id || this._sourceKey(t, l), u = e.on_timeout, h = u === null ? "clear" : e.off_event || "none";
    return {
      entity_id: t,
      source_id: d,
      signal_key: l,
  ...
  _getOccupancyStateForLocation(t) {
    var n, o, a;
    const e = (n = this.occupancyRuntimeStates) == null ? void 0 : n[t];
    if (e)
      return e;
    const i = (o = this.occupancyStates) == null ? void 0 : o[t];
    if (typeof i == "boolean") {
      const r = ((a = this.occupancyTransitions) == null ? void 0 : a[t]) || {};
      return {
        entity_id: `binary_sensor.topomation_occupancy_projection_${t}`,
        state: i ? "on" : "off",
        last_changed: r.changedAt,
        last_updated: r.changedAt,
        attributes: {
          device_class: "occupancy",
          location_id: t,
          previous_occupied: r.previousOccupied,
          reason: r.reason,
          locked_by: [],
          is_locked: !1,
          lock_modes: [],
  ...
  _aggregateOccupiedStateForStructural() {
    if (!(!this.location || !this._isStructuralSummaryLocation()))
  ...
  _aggregateDescendantContributionsForStructural() {
    ...
    return this._descendantLocationIds(this.location.id).flatMap((e) => {
      ...
      return (Array.isArray(a.contributions) ? a.contributions : []).map((d) => {
        ...
        if (t.has(h)) return;
        t.add(h);
        const _ = this._parseDateValue(d == null ? void 0 : d.updated_at) || this._parseDateValue(d == null ? void 0 : d.changed_at) || this._parseDateValue(d == null ? void 0 : d.last_changed) || this._parseDateValue(d == null ? void 0 : d.timestamp), p = String((d == null ? void 0 : d.state) || (d == null ? void 0 : d.state_value) || "").trim() || "active", f = _ ? `${this._formatElapsedDuration(_)} ago` : "active", m = this._sourceLabelForSourceId(o, u);
        return {
  ...
  _structureSummary() {
    if (!this.location || !this._isStructuralSummaryLocation()) return;
    const t = this._managedShadowLocationIds(), e = this._descendantLocations(this.location.id).filter(
      (a) => !this._isManagedShadowLocation(a, t)
    ), i = e.filter((a) => {
      var r;
      return a.parent_id === ((r = this.location) == null ? void 0 : r.id);
    }).length, n = e.filter((a) => {
      const r = z(a);
      return r === "area" || r === "subarea";
    }).length, o = e.filter((a) => {
      const r = this._getOccupancyStateForLocation(a.id);
      return this._resolveOccupiedState(r, a.id) === !0;
    }).length;
    return {
      directChildren: i,
      descendantRooms: n,
      occupiedDescendants: o
    };
  }
  _resolveOccupiedState(t, e) {
    var c, l, d, u, h;
    const i = e ?? ((c = this.location) == null ? void 0 : c.id) ?? "", n = i ? (l = this.occupancyTransitions) == null ? void 0 : l[i] : void 0, o = (d = this._parseDateValue(n == null ? void 0 : n.changedAt)) == null ? void 0 : d.getTime(), a = (u = this._parseDateValue(
    ...
    if ((t == null ? void 0 : t.state) === "off")
      return !1;
    const r = i ? (h = this.occupancyStates) == null ? void 0 : h[i] : void 0;
    if (typeof r == "boolean")
      return r;
  }
  ...
  _resolveVacancyReason(t, e) {
    var a, r, c, l, d;
    if (e !== !1) return;
    const i = this._runtimeProjectionLocationId();
    if (!i) return;
  ...
  _resolveOccupiedReason(t, e) {
    ...
    if (((h = (u = this.occupancyTransitions) == null ? void 0 : u[i]) == null ? void 0 : h.occupied) === !0) {
    ...
    return r.length ? `Contributed by ${r[0].sourceLabel}` : "No source-level evidence available";
  }
  ...
  _recentExplainabilityCurrentState() {
    ...
    if (!t) return;
    const e = this._isStructuralSummaryLocation(), i = this._treeAlignedOccupiedState(t) === !0, n = t.attributes || {}, o = this._occupancyContributions(this._getOccupancyConfig(), !0), a = this._resolveVacantAt(n, i), r = this._getLockState(), c = this.location ? gi({
      location: this.location,
      locations: this.allLocations,
      hass: this.hass,
      occupancyStates: this.occupancyStates,
      occupancyTransitions: this.occupancyTransitions,
      occupancyRuntimeStates: this.occupancyRuntimeStates,
      status: i ? "occupied" : "vacant",
      nowMs: this._nowEpochMs
    }) : void 0, l = i ? (c == null ? void 0 : c.summary) || this._resolveOccupiedReason(t, !0) || "Occupied." : (c == null ? void 0 : c.summary) || this._resolveVacancyReason(t, !1) || "No active contributors remain";
    let d;
    i && (a instanceof Date ? d = `Vacates ${this._formatDateTime(a)}` : e ? d = "Held by occupied rooms" : a === null && (d = "Held by presence"));
    let u;
    return r.isLocked && (u = r.lockedBy.length ? `Held by ${r.lockedBy.map((h) => this._lockSourceLabel(h)).join(", ")}` : "Occupancy is held by a lock"), {
      occupied: i,
      why: l,
      nextChange: d,
      lockedSummary: u,
  ...
  _normalizeExplainabilityChange(t) {
    ...
    if (!(!e || !i))
      return {
        ...
        previousOccupied: typeof t.previous_occupied == "boolean" ? t.previous_occupied : void 0,
        changedAt: typeof t.changed_at == "string" && t.changed_at.trim() ? t.changed_at : void 0
      };
  }
  _explainabilityChangeTitle(t) {
    return t.kind === "state" ? t.event === "occupied" && t.previousOccupied === !0 ? "Occupancy refreshed" : t.event === "vacant" && t.previousOccupied === !1 ? "Still vacant" : t.event === "occupied" ? "Location became occupied" : "Location became vacant" : t.event === "trigger" ? "Source triggered" : t.event === "clear" ? "Source cleared" : t.event === "vacate" ? "Vacate requested" : `Source ${t.event}`;
  }
  _explainabilityChangeDescription(t, e) {
    if (t.kind === "state") {
      const n = this._formatOccupancyReason(t.reason);
      return n || (t.event === "occupied" && t.previousOccupied === !0 ? "Occupancy was refreshed while already occupied" : t.event === "vacant" && t.previousOccupied === !1 ? "Occupancy remained vacant" : t.event === "occupied" ? "Occupancy turned on" : "Occupancy turned off");
    }
  ...
  _occupancyContributions(t, e = !1) {
    ...
    for (const h of r) {
      const _ = c.get(h.sourceId);
      (!_ || h._timestampMs > _._timestampMs) && c.set(h.sourceId, h);
    }
    const d = [...[...c.values()]].sort((h, _) => h._active !== _._active ? h._active ? -1 : 1 : _._timestampMs - h._timestampMs);
    return (e ? d.filter((h) => h._active) : d).map(({ sourceLabel: h, stateLabel: _, relativeTime: p, sourceId: f }) => ({
      sourceLabel: h === f || this._structuralSourceLabel(f) ? h : `${h} (${f})`,
      sourceId: f,
      stateLabel: _,
      relativeTime: p
    }));
  ...
  _isContributionActive(t) {
    ...
    if (e === "off" || e === "inactive" || e === "vacant" || e === "clear")
      return !1;
    if (e === "on" || e === "active" || e === "occupied" || e === "trigger" || t.expires_at === null || t.expires_at === void 0) return !0;
  ...
  _structuralSourceLabel(t) {
    ...
    return i("__child__", ":", "Child location") || i("__child__", ".", "Child location") || i("__follow__", ":", "Parent location") || i("__follow__", ".", "Parent location") || n() || this._knownLocationLabel(e);
  }
  ...
  _entityStateObj(t) {
    var e, i;
    return this._liveSourceEntityStates[t] || ((i = (e = this.hass) == null ? void 0 : e.states) == null ? void 0 : i[t]);
  }
  _entityName(t) {
    var e, i;
    return ((i = (e = this._entityStateObj(t)) == null ? void 0 : e.attributes) == null ? void 0 : i.friendly_name) || t;
  }
  /** Home Assistant `device_class` when set (used for occupancy source UX). */
  _entityDeviceClass(t) {
    var n, o;
    const e = (o = (n = this._entityStateObj(t)) == null ? void 0 : n.attributes) == null ? void 0 : o.device_class;
  ...
  _entityState(t) {
    var i;
    const e = (i = this._entityStateObj(t)) == null ? void 0 : i.state;
    return e || "unknown";
  }
  _entityStateBadgeTone(t) {
    var i;
    const e = String(((i = this._entityStateObj(t)) == null ? void 0 : i.state) || "unknown").trim();
...
if (!customElements.get("ht-location-inspector"))
  try {
    customElements.define("ht-location-inspector", xi);
  } catch (s) {
...
var xn, wn;
try {
  (wn = (xn = import.meta) == null ? void 0 : xn.hot) == null || wn.accept(() => window.location.reload());
} catch {
}
const Le = class Le extends ft {
  constructor() {
  ...
  render() {
    ...
    console.log("[LocationDialog] Rendering dialog with schema:", t.length, "fields");
    const e = this._getValidParents(), i = this._includeRootOption(), n = i || e.length > 1;
    return g`
      <ha-dialog
        .open=${this.open}
        ...
        <div class="dialog-content">
          ...
          ${n ? g`
            <div class="field">
              ...
              >
                ${i ? g`<option value="">Root Level</option>` : ""}
                ${e.map((o) => g`
                  <option value=${o.value}>${o.label}</option>
                `)}
              </select>
   ...
   */
  _getValidParents() {
    const t = this._config.type, e = ci(t);
...
let wi = Le;
customElements.get("ht-location-dialog") || customElements.define("ht-location-dialog", wi);
const _n = "topomation:panel-tree-split", fn = "topomation:panel-right-mode", oi = 0.4, ai = 0.25, ri = 0.75, er = "application/x-topomation-entity-id", mn = "manual_ui", ir = 550;
var Sn, $n;
try {
  ($n = (Sn = import.meta) == null ? void 0 : Sn.hot) == null || $n.accept(() => window.location.reload());
} catch {
}
const Ie = class Ie extends ft {
  constructor() {
    super(), this.narrow = !1, this._allLocations = [], this._locations = [], this._locationsVersion = 0, this._loading = !0, this._pendingChanges = /* @__PURE__ */ new Map(), this._saving = !1, this._discarding = !1, this._locationDialogOpen = !1, this._occupancyStateByLocation = {}, this._occupancyTransitionByLocation = {}, this._occupancyRuntimeStateByLocation = {}, this._adjacencyEdges = [], this._handoffTraceByLocation = {}, this._treePanelSplit = oi, this._isResizingPanels = !1, this._entityAreaById = {}, this._entitySearch = "", this._assignBusyByEntityId = {}, this._rightPanelMode = "inspector", this._assignmentFilter = "all", this._deviceGroupExpanded = {}, this._haRegistryRevision = 0, this._hasLoaded = !1, this._loadSeq = 0, this._entityAreaIndexLoaded = !1, this._entityAreaRevision = 0, this._deviceGroupsCache = [], this._opQueueByLocationId = /* @__PURE__ */ new Map(), this._occupancyManualToggleCooldownUntilByLocationId = /* @__PURE__ */ new Map(), this._resumeRefreshQueued = !1, this._handleDeviceSearch = (t) => {
      var i;
      ...
      if (t.key === "Home") {
        t.preventDefault(), this._setPanelSplit(ai, !0);
        return;
      }
      t.key === "End" && (t.preventDefault(), this._setPanelSplit(ri, !0));
    }, this._handlePanelSplitterReset = () => {
      this._setPanelSplit(oi, !0);
    };
  }
  get hass() {
    return this._hass;
  ...
  set hass(t) {
    const e = this._hass;
    e !== t && (this._hass = t, this._handleHassChanged(e, t), this.requestUpdate("hass", e));
  }
  ...
  _handleHassChanged(t, e) {
    !this._hasLoaded && e && (this.isConnected ? this._scheduleInitialLoad() : this._queueInitialLoad());
    const i = t == null ? void 0 : t.connection, n = e == null ? void 0 : e.connection;
    if (i !== n) {
      if (!n) {
  ...
  _queueInitialLoad() {
    this._hasLoaded || this._pendingLoadTimer || (this._pendingLoadTimer = window.setTimeout(() => {
      this._pendingLoadTimer = void 0, this._scheduleInitialLoad();
    }, 0));
  }
  connectedCallback() {
    ...
    return g`
      <div class="panel-container" style=${`--tree-panel-basis: ${l};`}>
        ...
        <div
          ...
          aria-valuemin=${Math.round(ai * 100)}
          aria-valuemax=${Math.round(ri * 100)}
    ...
    if ((e = this.hass) != null && e.callWS && !(!t && this._entityAreaIndexLoaded)) {
      ...
      this._entityAreaIndexPromise = (async () => {
        try {
          ...
          if (Array.isArray(n))
            for (const u of n) {
              const h = typeof (u == null ? void 0 : u.id) == "string" ? u.id : void 0, _ = typeof (u == null ? void 0 : u.area_id) == "string" ? u.area_id : void 0;
              h && _ && o.set(h, _);
            }
          const a = {};
          if (Array.isArray(i))
            for (const u of i) {
              const h = typeof (u == null ? void 0 : u.entity_id) == "string" ? u.entity_id : void 0;
              if (!h) continue;
              const _ = typeof (u == null ? void 0 : u.area_id) == "string" ? u.area_id : void 0, p = typeof (u == null ? void 0 : u.device_id) == "string" ? o.get(u.device_id) : void 0;
              a[h] = _ || p || null;
            }
          const r = this._entityAreaById, c = Object.keys(r), l = Object.keys(a);
          (c.length !== l.length || l.some((u) => r[u] !== a[u])) && (this._entityAreaById = a, this._entityAreaRevision += 1), this._entityAreaIndexLoaded = !0;
        } catch {
        }
      })();
      try {
  ...
  _handleDeviceDragStart(t, e) {
    var i, n;
    (i = t.dataTransfer) == null || i.setData(er, e), (n = t.dataTransfer) == null || n.setData("text/plain", e), t.dataTransfer && (t.dataTransfer.effectAllowed = "move");
  }
  ...
  _buildDeviceGroups() {
    ...
    for (const u of this._locations)
      for (const h of u.entity_ids || [])
        h && !o.has(h) && o.set(h, u.id);
    const a = /* @__PURE__ */ new Map(), r = (u, h, _, p) => {
      const f = a.get(u);
      if (f) return f;
      const m = { key: u, label: h, type: _, locationId: p, entities: [] };
      return a.set(u, m), m;
    };
    r("unassigned", "Unassigned", "unassigned");
    for (const u of this._allKnownEntityIds()) {
      if (!this._isAssignableEntity(u)) continue;
      const h = this._entityDisplayName(u), _ = o.get(u), p = _ ? n.get(_) : void 0, f = this._areaLabel(this._effectiveAreaIdForEntity(u));
      if (t && !`${h} ${u} ${(p == null ? void 0 : p.name) || ""} ${f}`.toLowerCase().includes(t))
        continue;
      if (!p) {
    ...
    for (const u of a.values())
      u.entities.sort(
        (h, _) => this._entityDisplayName(h).localeCompare(this._entityDisplayName(_))
      );
    const c = {
      unassigned: 0,
      area: 1,
      ...
      grounds: 5,
      other: 6
    }, l = [...a.values()].filter((u) => u.entities.length > 0 || u.key === "unassigned").sort((u, h) => {
      const _ = c[u.type] - c[h.type];
      return _ !== 0 ? _ : u.label.localeCompare(h.label);
    });
  ...
  async _loadLocations(t = !1) {
    ...
    try {
      ...
      const o = await Promise.race([
        ...
        new Promise(
          (u, h) => setTimeout(() => h(new Error("Timeout loading locations")), 8e3)
        )
      ]);
      if (!o || !o.locations)
      ...
      if (e !== this._loadSeq)
        return;
      const a = /* @__PURE__ */ new Map();
      for (const u of o.locations) a.set(u.id, u);
      const r = Array.from(a.values()), c = ee(r), l = r.filter(
        (u) => !u.is_explicit_root && !ie(u, c)
      );
      this._allLocations = [...r], this._locations = [...l], this._adjacencyEdges = Array.isArray(o.adjacency_edges) ? [...o.adjacency_edges] : [];
      const d = Array.isArray(o.occupancy_states) ? o.occupancy_states : await this._loadOccupancyRuntimeStates();
      this._replaceOccupancyRuntimeStates(
        d,
        new Set(r.map((u) => u.id))
      ), this._locationsVersion += 1, (!this._selectedId || !this._locations.some((u) => u.id === this._selectedId) || this._isManagedShadowLocation(this._locations.find((u) => u.id === this._selectedId))) && (this._selectedId = this._preferredSelectedLocationId()), this._rightPanelMode === "assign" && this._ensureEntityAreaIndex();
    } catch (n) {
  ...
  _getLocationLockState(t) {
    var n;
    const e = ((n = this._occupancyRuntimeStateByLocation[t]) == null ? void 0 : n.attributes) || {}, i = Array.isArray(e == null ? void 0 : e.locked_by) ? e.locked_by.map((o) => String(o)) : [];
    return {
      isLocked: !!(e != null && e.is_locked),
      lockedBy: i
    };
  }
  _getLocationOccupiedState(t) {
    return this._occupancyStateByLocation[t];
  }
  _getLocationOccupiedForToggle(t) {
    return this._getLocationOccupiedState(t);
  }
  async _handleLocationOccupancyToggle(t) {
    ...
    await this._enqueueLocationOp(e, async () => {
      ...
      if (c) {
        const _ = l.length ? ` (${l.map((p) => Ti(p)).join(", ")})` : "";
        this._showToast(`Hey, can't do it. "${r}" is locked${_}.`, "warning");
        return;
      }
      const d = this._occupancyManualToggleCooldownUntilByLocationId.get(e);
      if (!(typeof d == "number" && Date.now() < d))
        try {
          if (!a) {
            this._showToast("Invalid occupancy request", "error");
            return;
  ...
  _clampPanelSplit(t) {
    return Number.isFinite(t) ? Math.min(ri, Math.max(ai, t)) : oi;
  }
  ...
  _restorePanelSplitPreference() {
    var t;
    try {
      const e = (t = window.localStorage) == null ? void 0 : t.getItem(_n);
      if (!e) return;
      const i = Number(e);
  ...
  _persistPanelSplitPreference() {
    var t;
    try {
      (t = window.localStorage) == null || t.setItem(_n, this._treePanelSplit.toFixed(4));
    } catch {
    }
  }
  _restoreRightPanelModePreference() {
    ...
    try {
      (t = window.localStorage) == null || t.removeItem(fn);
    } catch {
    }
  }
  ...
  async _subscribeToUpdates() {
    ...
    if (!(this._updatesSubscriptionConnection === t && this._unsubUpdates && this._unsubOccupancyChanged && this._unsubHandoffTrace && this._unsubEntityRegistryUpdated && this._unsubDeviceRegistryUpdated && this._unsubAreaRegistryUpdated)) {
      ...
      try {
        this._unsubOccupancyChanged = await t.subscribeEvents(
          (i) => {
            var o, a;
            const n = Array.isArray((o = i == null ? void 0 : i.data) == null ? void 0 : o.states) ? i.data.states : (a = i == null ? void 0 : i.data) != null && a.state ? [i.data.state] : [];
            this._applyOccupancyRuntimeStates(n);
          },
          "topomation_occupancy_state_changed"
        );
      } catch (i) {
        console.warn("Failed to subscribe to topomation_occupancy_state_changed events", i);
      }
      try {
        this._unsubHandoffTrace = await t.subscribeEvents(
          (i) => {
            ...
            let d = l(this._handoffTraceByLocation, a, c);
            d = l(d, r, c), this._handoffTraceByLocation = d;
          },
  ...
  async _loadOccupancyRuntimeStates() {
    var t;
    if (!((t = this.hass) != null && t.callWS)) return [];
    try {
      const e = await this.hass.callWS(
        this._withEntryId({
      ...
      return Array.isArray(e == null ? void 0 : e.states) ? e.states : [];
    } catch (e) {
      return console.warn("Failed to load backend occupancy projection", e), [];
    }
  }
  _replaceOccupancyRuntimeStates(t, e) {
    const i = t.filter((n) => {
      const o = typeof (n == null ? void 0 : n.location_id) == "string" ? n.location_id : "";
      return o && (!e || e.has(o));
    });
    this._applyOccupancyRuntimeStates(i, !0);
  }
  _applyOccupancyRuntimeStates(t, e = !1) {
    if (!Array.isArray(t)) return;
    const i = e ? {} : { ...this._occupancyRuntimeStateByLocation }, n = e ? {} : { ...this._occupancyStateByLocation }, o = e ? {} : { ...this._occupancyTransitionByLocation };
    for (const a of t) {
      ...
      if (!e && i[r]) {
        ...
        }, h = typeof d.state == "string" ? d.state : void 0, _ = typeof l.state == "string" ? l.state : void 0, p = Date.parse(String(d.last_changed || "")), f = Date.parse(String(l.last_changed || ""));
        typeof c == "boolean" && a.previous_occupied === c && !!h && h === _ && Number.isFinite(p) && Number.isFinite(f) && f > p && (u.last_changed = d.last_changed), i[r] = u;
      } else
        i[r] = l;
      typeof c == "boolean" && (n[r] = c, o[r] = {
        ...
        changedAt: typeof a.changed_at == "string" && a.changed_at.trim().length ? a.changed_at : void 0
      });
    }
...
${e}`);
  ...
  _isManagedShadowLocation(t) {
    return t ? ie(t, this._managedShadowLocationIds()) : !1;
  }
  _managedShadowLocationIds() {
    return ee(this._allLocations);
  }
...
Ie.properties = {
  ...
  _occupancyRuntimeStateByLocation: { state: !0 },
